Namespace ekaw
	...
	#Region " Interface Abstract "
		Interface Abstract : Inherits Paper, Document, Extended_abstract
			''' <summary>
	...
	#Region " Interface Track "
		Interface Track : Inherits Conference_part, Scientific_Event
	...
	#Region " Interface Workshop "
		Interface Workshop : Inherits Working_event, Scientific_Event, AcademicEvent, [Event], Conference_part
			
		End Interface
	#End Region

	#Region " Interface Tutorial "
		Interface Tutorial : Inherits Working_event, Conference_part, Individual_Presentation
	...
	#Region " Interface Author "
		Interface Author : Inherits User, ConferenceMember, Person
			''' <summary>
	...
	#Region " Interface conference "
		Interface conference : Inherits Thing, [Event], Working_event, Scientific_Event
	...
	#Region " Interface Review "
		Interface Review : Inherits article, Document, Conference_document
			''' <summary>
	...
	#Region " Interface Reviewer "
		Interface Reviewer : Inherits Person, ConferenceMember, User
	...
	#Region " Interface Paper "
		Interface Paper : Inherits Document, Contribution, article, Regular_contribution
	...
	#Region " Interface Session "
		Interface Session : Inherits Scientific_Event
	...
	#Region " Interface University "
		Interface University : Inherits Academic_Institution, Organization
	...
	#Region " Interface Presenter "
		Interface Presenter : Inherits Author, Conference_Participant
