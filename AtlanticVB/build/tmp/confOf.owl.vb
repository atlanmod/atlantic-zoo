Namespace confOf
	...
	#Region " Interface Conference "
		Interface Conference : Inherits Thing, Working_event, [Event]
			''' <summary>
	...
	#Region " Interface Paper "
		Interface Paper : Inherits Document, Contribution, Regular_contribution
			''' <summary>
	...
	#Region " Interface Workshop "
		Interface Workshop : Inherits Conference_part, [Event], Working_event
			
		End Interface
	#End Region

	#Region " Interface Tutorial "
		Interface Tutorial : Inherits Conference_part, Working_event
	...
	#Region " Interface review "
		Interface review : Inherits article
			Property gives_classification As [[classification]]
