Namespace crsdr
	...
	#Region " Interface Conference "
		Interface Conference : Inherits Thing, [Event], Working_event
			''' <summary>
	...
	#Region " Interface Review "
		Interface Review : Inherits Conference_document, Document
			''' <summary>
	...
	#Region " Interface Paper "
		Interface Paper : Inherits Regular_contribution, Document, Contribution
			''' <summary>
	...
	#Region " Interface Author "
		Interface Author : Inherits ConferenceMember, User, Person
			''' <summary>
	...
	#Region " Interface Workshop "
		Interface Workshop : Inherits Working_event, Conference_part, [Event]
	...
	#Region " Interface paper "
		Interface paper : Inherits article
	...
	#Region " Interface author "
		Interface author : Inherits person
			''' <summary>
	...
	#Region " Interface review "
		Interface review : Inherits document, article
			Property gives_classification As [[classification]]
	...
	#Region " Interface reviewer "
		Interface reviewer : Inherits person
			''' <summary>
