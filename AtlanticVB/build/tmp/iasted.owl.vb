Namespace iasted
	...
	#Region " Interface Reviewer "
		Interface Reviewer : Inherits ConferenceMember, User, Speaker, Person
	...
	#Region " Interface Person "
		Interface Person : Inherits Thing
			...
			''' <summary>
			''' authorOf oppositeOf writtenBy
			''' </summary>
			Property authorOf As [[Document]]

			''' <summary>
			''' prepare oppositeOf is_prepared_by
			''' </summary>
			Property prepare As [[Item]]

			Property occupy As List(Of [[Presenter_city]]

			Property is_present_in As List(Of [[Thing]]

			''' <summary>
			''' write oppositeOf is_writen_by
			''' </summary>
			Property write As [[Item]]

			Property obtain As [[Item]]

			''' <summary>
			''' send oppositeOf is_sent_by
			''' </summary>
			Property send As [[Item]]

			Property speak_in As List(Of [[Thing]]

			''' <summary>
			''' pay oppositeOf is_paid_by
			''' </summary>
			Property pay As [[Money]]

			''' <summary>
			''' sign oppositeOf is_signed_by
			''' </summary>
			Property sign As [[Item]]

			Property is_present As [[Time]]

			Property give As List(Of [[Thing]]

			''' <summary>
			''' need oppositeOf is_needed_for
			''' </summary>
			Property need As [[Item]]
	...
	#Region " Interface Conference "
		Interface Conference : Inherits Thing, Scientific_Event, [Event], Working_event
	...
	#Region " Interface Abstract "
		Interface Abstract : Inherits Extended_abstract, Paper, Document
			''' <summary>
	...
	#Region " Interface Tutorial "
		Interface Tutorial : Inherits Conference_part, Session, Individual_Presentation, Working_event
	...
	#Region " Interface University "
		Interface University : Inherits Organization, Academic_Institution
	...
	#Region " Interface Workshop "
		Interface Workshop : Inherits AcademicEvent, Working_event, Conference_part, [Event], Scientific_Event
	...
	#Region " Interface [Event] "
		Interface [Event] : Inherits Thing
			...
			Property eventOnList As List(Of [[Thing]]

			Property partOfEvent As [[Event]]

			Property hasEvent As [[Event]]

			Property organisedBy As List(Of [[Thing]]

			''' <summary>
			''' heldIn oppositeOf locationOf
			''' </summary>
			Property heldIn As [[Location]]
		End Interface
	#End Region

	#Region " Interface Accepted_Paper "
		Interface Accepted_Paper : Inherits Evaluated_Paper
			
		End Interface
	#End Region

	#Region " Interface Rejected_Paper "
		Interface Rejected_Paper : Inherits Evaluated_Paper
			
		End Interface
	#End Region

	#Region " Interface Evaluated_Paper "
		Interface Evaluated_Paper : Inherits Assigned_Paper
			Property hasReview As [[Review]]
		End Interface
	#End Region

	#Region " Interface Camera_Ready_Paper "
		Interface Camera_Ready_Paper : Inherits Paper
			
		End Interface
	#End Region

	#Region " Interface Positive_Review "
		Interface Positive_Review : Inherits Review
			
		End Interface
	#End Region

	#Region " Interface Workshop_Paper "
		Interface Workshop_Paper : Inherits Paper
			
		End Interface
	#End Region

	#Region " Interface Industrial_Paper "
		Interface Industrial_Paper : Inherits Paper
			
		End Interface
	#End Region

	#Region " Interface Paper "
		Interface Paper : Inherits Contribution, article, Regular_contribution, Document
			''' <summary>
			...
			''' <summary>
			''' hasReview oppositeOf reviewOfPaper
			''' </summary>
			Property hasReview As [[Review]]

			''' <summary>
			''' hasReviewer oppositeOf reviewerOfPaper
			''' </summary>
			Property hasReviewer As [[Possible_Reviewer]]
		End Interface
	#End Region

	#Region " Interface Conference_Paper "
		Interface Conference_Paper : Inherits Paper
			
		End Interface
	#End Region

	#Region " Interface Industrial_Session "
		Interface Industrial_Session : Inherits Conference_Session
			
		End Interface
	#End Region

	#Region " Interface Conference_Session "
		Interface Conference_Session : Inherits Session
			
		End Interface
	#End Region

	#Region " Interface Regular_Session "
		Interface Regular_Session : Inherits Session
			
		End Interface
	#End Region

	#Region " Interface Poster_Session "
		Interface Poster_Session : Inherits Session
			
		End Interface
	#End Region

	#Region " Interface Demo_Session "
		Interface Demo_Session : Inherits Session
			
		End Interface
	#End Region

	#Region " Interface Paper_Author "
		Interface Paper_Author : Inherits Person
			
		End Interface
	#End Region

	#Region " Interface Conference_Trip "
		Interface Conference_Trip : Inherits Social_Event
	...
	#Region " Interface Tutorial_Abstract "
		Interface Tutorial_Abstract : Inherits Abstract
	...
	#Region " Interface Submitted_Paper "
		Interface Submitted_Paper : Inherits Paper
			
		End Interface
	#End Region

	#Region " Interface Assigned_Paper "
		Interface Assigned_Paper : Inherits Submitted_Paper
			Property hasReviewer As [[Possible_Reviewer]]
		End Interface
	#End Region

	#Region " Interface Negative_Review "
		Interface Negative_Review : Inherits Review
			
		End Interface
	#End Region

	#Region " Interface Neutral_Review "
		Interface Neutral_Review : Inherits Review
			
		End Interface
	#End Region

	#Region " Interface Research_Topic "
		Interface Research_Topic
			Property topicCoveredBy As [[Thing]]
		End Interface
	#End Region

	#Region " Interface Organising_Agency "
		Interface Organising_Agency : Inherits Organisation
			
		End Interface
	#End Region

	#Region " Interface Academic_Institution "
		Interface Academic_Institution : Inherits Organisation
			Property scientificallyOrganises As [[Academic_Institution]]
		End Interface
	#End Region

	#Region " Interface Organisation "
		Interface Organisation
			Property publisherOf As List(Of [[Thing]]

			Property technicallyOrganises As [[Thing]]
		End Interface
	#End Region

	#Region " Interface Proceedings_Publisher "
		Interface Proceedings_Publisher : Inherits Organisation
			
		End Interface
	#End Region

	#Region " Interface Poster_Paper "
		Interface Poster_Paper : Inherits Paper
			
		End Interface
	#End Region

	#Region " Interface Regular_Paper "
		Interface Regular_Paper : Inherits Paper
			
		End Interface
	#End Region

	#Region " Interface Demo_Paper "
		Interface Demo_Paper : Inherits Paper
			
		End Interface
	#End Region

	#Region " Interface Location "
		Interface Location
			''' <summary>
			''' locationOf oppositeOf heldIn
			''' </summary>
			Property locationOf As [[Event]]
		End Interface
	#End Region

	#Region " Interface Research_Institute "
		Interface Research_Institute : Inherits Academic_Institution
			
		End Interface
	#End Region

	#Region " Interface Scientific_Event "
		Interface Scientific_Event : Inherits [Event]
			
		End Interface
	#End Region

	#Region " Interface Invited_Talk_Abstract "
		Interface Invited_Talk_Abstract : Inherits Abstract
			
		End Interface
	#End Region

	#Region " Interface Agency_Staff_Member "
		Interface Agency_Staff_Member : Inherits Person
			
		End Interface
	#End Region

	#Region " Interface Workshop_Session "
		Interface Workshop_Session : Inherits Session
			
		End Interface
	#End Region

	#Region " Interface Track "
		Interface Track : Inherits Scientific_Event, Conference_part
			
		End Interface
	#End Region

	#Region " Interface Invited_Talk "
		Interface Invited_Talk : Inherits Individual_Presentation
			
		End Interface
	#End Region

	#Region " Interface Contributed_Talk "
		Interface Contributed_Talk : Inherits Individual_Presentation
			Property presentationOfPaper As List(Of [[Document]]
		End Interface
	#End Region

	#Region " Interface Demo_Chair "
		Interface Demo_Chair : Inherits Conference_Participant
			
		End Interface
	#End Region

	#Region " Interface Tutorial_Chair "
		Interface Tutorial_Chair : Inherits Conference_Participant, PC_Member
			
		End Interface
	#End Region

	#Region " Interface PC_Chair "
		Interface PC_Chair : Inherits Conference_Participant, PC_Member
			
		End Interface
	#End Region

	#Region " Interface PC_Member "
		Interface PC_Member : Inherits Possible_Reviewer
			
		End Interface
	#End Region

	#Region " Interface OC_Member "
		Interface OC_Member : Inherits Conference_Participant
			
		End Interface
	#End Region

	#Region " Interface Proceedings "
		Interface Proceedings : Inherits [Multi-author_Volume]
			
		End Interface
	#End Region

	#Region " Interface Programme_Brochure "
		Interface Programme_Brochure : Inherits Document
			
		End Interface
	#End Region

	#Region " Interface Flyer "
		Interface Flyer : Inherits Document
			
		End Interface
	#End Region

	#Region " Interface Web_Site "
		Interface Web_Site : Inherits Document
			
		End Interface
	#End Region

	#Region " Interface [Multi-author_Volume] "
		Interface [Multi-author_Volume] : Inherits Document
			
		End Interface
	#End Region

	#Region " Interface Individual_Presentation "
		Interface Individual_Presentation : Inherits Scientific_Event
			Property presentationOfPaper As List(Of [[Document]]
		End Interface
	#End Region

	#Region " Interface OC_Chair "
		Interface OC_Chair : Inherits OC_Member
			
		End Interface
	#End Region

	#Region " Interface Conference_Banquet "
		Interface Conference_Banquet : Inherits Social_Event
			
		End Interface
	#End Region

	#Region " Interface Workshop_Chair "
		Interface Workshop_Chair : Inherits Conference_Participant, PC_Member
			
		End Interface
	#End Region

	#Region " Interface Conference_Proceedings "
		Interface Conference_Proceedings : Inherits Proceedings
			
		End Interface
	#End Region

	#Region " Interface Session_Chair "
		Interface Session_Chair : Inherits PC_Member, Conference_Participant
			
		End Interface
	#End Region

	#Region " Interface [Early-Registered_Participant] "
		Interface [Early-Registered_Participant] : Inherits Conference_Participant
			
		End Interface
	#End Region

	#Region " Interface [Late-Registered_Participant] "
		Interface [Late-Registered_Participant] : Inherits Conference_Participant
			
		End Interface
	#End Region

	#Region " Interface Possible_Reviewer "
		Interface Possible_Reviewer : Inherits Person
			''' <summary>
			''' reviewerOfPaper oppositeOf hasReviewer
			''' </summary>
			Property reviewerOfPaper As [[Paper]]
		End Interface
	#End Region

	#Region " Interface Student "
		Interface Student : Inherits Person
			
		End Interface
	#End Region

	#Region " Interface Invited_Speaker "
		Interface Invited_Speaker : Inherits Presenter
			
		End Interface
	#End Region

	#Region " Interface Presenter "
		Interface Presenter : Inherits Conference_Participant, Author
			
		End Interface
	#End Region

	#Region " Interface SC_Member "
		Interface SC_Member : Inherits PC_Member
			
		End Interface
	#End Region

	#Region " Interface Presenter_house "
		Interface Presenter_house : Inherits Building
			
		End Interface
	#End Region

	#Region " Interface Building "
		Interface Building : Inherits Place
			
		End Interface
	#End Region

	#Region " Interface Presenter_state "
		Interface Presenter_state : Inherits State
			
		End Interface
	#End Region

	#Region " Interface Delegate "
		Interface Delegate : Inherits Person
			
		End Interface
	#End Region

	#Region " Interface Presenter_city "
		Interface Presenter_city : Inherits City
			
		End Interface
	#End Region

	#Region " Interface Hotel_registration_form "
		Interface Hotel_registration_form : Inherits Form
			
		End Interface
	#End Region

	#Region " Interface Deadline_hotel_reservation "
		Interface Deadline_hotel_reservation : Inherits Deadline
			
		End Interface
	#End Region

	#Region " Interface Form "
		Interface Form : Inherits Document
			
		End Interface
	#End Region

	#Region " Interface Car "
		Interface Car : Inherits Transport_vehicle
			
		End Interface
	#End Region

	#Region " Interface Transport_vehicle "
		Interface Transport_vehicle : Inherits Item
			
		End Interface
	#End Region

	#Region " Interface Mailing_list "
		Interface Mailing_list : Inherits Document
			
		End Interface
	#End Region

	#Region " Interface Document "
		Interface Document : Inherits Item, Thing
			''' <summary>
			...
			''' <summary>
			''' writtenBy oppositeOf authorOf
			''' </summary>
			Property writtenBy As [[Person]]

			Property hasUpdatedVersion As [[Document]]

			Property updatedVersionOf As [[Document]]
		End Interface
	#End Region

	#Region " Interface Renting "
		Interface Renting : Inherits Activity_before_conference
			
		End Interface
	#End Region

	#Region " Interface Activity_before_conference "
		Interface Activity_before_conference : Inherits Activity
			
		End Interface
	#End Region

	#Region " Interface Dinner_banquet "
		Interface Dinner_banquet : Inherits Social_program
			
		End Interface
	#End Region

	#Region " Interface One_day_presenter "
		Interface One_day_presenter : Inherits Delegate
			
		End Interface
	#End Region

	#Region " Interface Social_program "
		Interface Social_program : Inherits Conference_activity
	...
	#Region " Interface Activity "
		Interface Activity
			...
			Property is_held_before As [[Time]]

			Property is_held_in As List(Of [[Trip_day]]

			Property is_held_after As [[Time]]

			Property is_dated_on As dateTime
		End Interface
	#End Region

	#Region " Interface PowerPoint_presentation "
		Interface PowerPoint_presentation : Inherits Presentation
			
		End Interface
	#End Region

	#Region " Interface Presentation "
		Interface Presentation : Inherits Conference_activity, Conference_contribution
			''' <summary>
			''' is_given_by oppositeOf give
			''' </summary>
			Property is_given_by As [[Active_conference_participant]]
		End Interface
	#End Region

	#Region " Interface Conference_restaurant "
		Interface Conference_restaurant : Inherits Building
			
		End Interface
	#End Region

	#Region " Interface Conference_city "
		Interface Conference_city : Inherits City
			
		End Interface
	#End Region

	#Region " Interface Conference_state "
		Interface Conference_state : Inherits State
			
		End Interface
	#End Region

	#Region " Interface Submissions_deadline "
		Interface Submissions_deadline : Inherits Deadline
			
		End Interface
	#End Region

	#Region " Interface Deadline "
		Interface Deadline : Inherits Time
			Property done_till As [[date]]
		End Interface
	#End Region

	#Region " Interface Simulating "
		Interface Simulating : Inherits Research
			
		End Interface
	#End Region

	#Region " Interface Research "
		Interface Research : Inherits Activity_before_conference
			
		End Interface
	#End Region

	#Region " Interface Technic_activity "
		Interface Technic_activity : Inherits Conference_activity
			
		End Interface
	#End Region

	#Region " Interface Conference_activity "
		Interface Conference_activity : Inherits Activity
			
		End Interface
	#End Region

	#Region " Interface Technical_commitee "
		Interface Technical_commitee : Inherits Delegate
			
		End Interface
	#End Region

	#Region " Interface Place "
		Interface Place : Inherits Thing
			''' <summary>
			''' isLocationOf oppositeOf hasLocation
			''' </summary>
			Property isLocationOf As [[ConferenceEvent]]

			Property is_equipped_by As [[Item]]
		End Interface
	#End Region

	#Region " Interface Author_cd_proceedings_included "
		Interface Author_cd_proceedings_included : Inherits Author
			
		End Interface
	#End Region

	#Region " Interface Author "
		Interface Author : Inherits Speaker, Person, ConferenceMember, User
	...
	#Region " Interface Cd_proceening "
		Interface Cd_proceening : Inherits Publication
			
		End Interface
	#End Region

	#Region " Interface Trip_day "
		Interface Trip_day : Inherits Time
	...
	#Region " Interface Record_of_attendance "
		Interface Record_of_attendance : Inherits Document
			
		End Interface
	#End Region

	#Region " Interface Listener "
		Interface Listener : Inherits Delegate
			
		End Interface
	#End Region

	#Region " Interface Session_room "
		Interface Session_room : Inherits Place
			
		End Interface
	#End Region

	#Region " Interface Brief_introduction_for_Session_chair "
		Interface Brief_introduction_for_Session_chair : Inherits Document
			
		End Interface
	#End Region

	#Region " Interface Session_chair "
		Interface Session_chair : Inherits Delegate
			
		End Interface
	#End Region

	#Region " Interface Invitation_letter "
		Interface Invitation_letter : Inherits Document
			
		End Interface
	#End Region

	#Region " Interface Registration_form "
		Interface Registration_form : Inherits Form
			
		End Interface
	#End Region

	#Region " Interface Viza "
		Interface Viza : Inherits Document
			
		End Interface
	#End Region

	#Region " Interface Registration "
		Interface Registration : Inherits Conference_activity
			
		End Interface
	#End Region

	#Region " Interface Conference_days "
		Interface Conference_days : Inherits Time
			
		End Interface
	#End Region

	#Region " Interface Conference_building "
		Interface Conference_building : Inherits Building
			
		End Interface
	#End Region

	#Region " Interface Registration_fee "
		Interface Registration_fee : Inherits Fee
			
		End Interface
	#End Region

	#Region " Interface Departure "
		Interface Departure : Inherits Activity_after_conference
			
		End Interface
	#End Region

	#Region " Interface Activity_after_conference "
		Interface Activity_after_conference : Inherits Activity
			
		End Interface
	#End Region

	#Region " Interface Conference_airport "
		Interface Conference_airport : Inherits Building
			
		End Interface
	#End Region

	#Region " Interface Worker_lecturer "
		Interface Worker_lecturer : Inherits Lecturer
			
		End Interface
	#End Region

	#Region " Interface Lecturer "
		Interface Lecturer : Inherits Author
			
		End Interface
	#End Region

	#Region " Interface Transparency "
		Interface Transparency : Inherits Document
			
		End Interface
	#End Region

	#Region " Interface Speaker "
		Interface Speaker : Inherits Delegate
			
		End Interface
	#End Region

	#Region " Interface City "
		Interface City : Inherits Thing
			
		End Interface
	#End Region

	#Region " Interface Card "
		Interface Card : Inherits Item
	...
	#Region " Interface Item "
		Interface Item
			Property go_through As [[Activity]]

			Property is_used_for As List(Of [[Thing]]

			''' <summary>
			''' is_signed_by oppositeOf sign
			''' </summary>
			Property is_signed_by As [[Person]]

			Property is_made_from As [[Item]]

			Property is_sent_after As [[Time]]

			''' <summary>
			''' is_needed_for oppositeOf need
			''' </summary>
			Property is_needed_for As [[Person]]

			Property is_sent_before As [[Time]]

			''' <summary>
			''' is_prepared_by oppositeOf prepare
			''' </summary>
			Property is_prepared_by As [[Person]]

			Property is_used_by As [[Person]]

			Property is_given_to As [[Person]]

			''' <summary>
			''' is_sent_by oppositeOf send
			''' </summary>
			Property is_sent_by As [[Person]]

			''' <summary>
			''' is_writen_by oppositeOf write
			''' </summary>
			Property is_writen_by As [[Person]]
		End Interface
	#End Region

	#Region " Interface Author_attendee_book_registration_fee "
		Interface Author_attendee_book_registration_fee : Inherits Registration_fee
			
		End Interface
	#End Region

	#Region " Interface Book_proceeding "
		Interface Book_proceeding : Inherits Publication
			
		End Interface
	#End Region

	#Region " Interface Video_cassette_player "
		Interface Video_cassette_player : Inherits Audiovisual_equipment
			
		End Interface
	#End Region

	#Region " Interface Audiovisual_equipment "
		Interface Audiovisual_equipment : Inherits Item
			
		End Interface
	#End Region

	#Region " Interface Video_presentation "
		Interface Video_presentation : Inherits Presentation
			
		End Interface
	#End Region

	#Region " Interface Hotel_room "
		Interface Hotel_room : Inherits Place
			
		End Interface
	#End Region

	#Region " Interface Hotel_presenter "
		Interface Hotel_presenter : Inherits Delegate
			
		End Interface
	#End Region

	#Region " Interface Conference_hotel "
		Interface Conference_hotel : Inherits Building
			
		End Interface
	#End Region

	#Region " Interface Money "
		Interface Money
			Property is_paid_with As [[Item]]

			''' <summary>
			''' is_paid_by oppositeOf pay
			''' </summary>
			Property is_paid_by As [[Person]]

			Property is_paid_in As [[Building]]

			Property is_paid_for As List(Of [[Thing]]

			Property has_amount_of As [[Money]]
		End Interface
	#End Region
	...
	#Region " Interface Introduction "
		Interface Introduction : Inherits Conference_activity
			
		End Interface
	#End Region

	#Region " Interface Welcome_address "
		Interface Welcome_address : Inherits Conference_activity
			
		End Interface
	#End Region

	#Region " Interface Value_added_tax "
		Interface Value_added_tax : Inherits Tax
			
		End Interface
	#End Region

	#Region " Interface Tax "
		Interface Tax : Inherits Money
			
		End Interface
	#End Region

	#Region " Interface Refusing_manuscript "
		Interface Refusing_manuscript : Inherits Activity_before_conference
			
		End Interface
	#End Region

	#Region " Interface Final_manuscript "
		Interface Final_manuscript : Inherits Submission
			
		End Interface
	#End Region

	#Region " Interface Accepting_manuscript "
		Interface Accepting_manuscript : Inherits Activity_before_conference
			
		End Interface
	#End Region

	#Region " Interface Sponsor_city "
		Interface Sponsor_city : Inherits City
			
		End Interface
	#End Region

	#Region " Interface Sponsor "
		Interface Sponsor : Inherits Person
			
		End Interface
	#End Region

	#Region " Interface Time_zone "
		Interface Time_zone
			
		End Interface
	#End Region

	#Region " Interface Introduction_of_speaker "
		Interface Introduction_of_speaker : Inherits Introduction
			
		End Interface
	#End Region

	#Region " Interface Conference_hall "
		Interface Conference_hall : Inherits Place
			
		End Interface
	#End Region

	#Region " Interface Plenary_lecture "
		Interface Plenary_lecture : Inherits Lecture
			
		End Interface
	#End Region

	#Region " Interface Lecture "
		Interface Lecture : Inherits Conference_activity
			
		End Interface
	#End Region

	#Region " Interface Plenary_lecture_speaker "
		Interface Plenary_lecture_speaker : Inherits Author
			
		End Interface
	#End Region

	#Region " Interface LCD_projector "
		Interface LCD_projector : Inherits Audiovisual_equipment
			
		End Interface
	#End Region

	#Region " Interface Deadline_for_notification_of_acceptance "
		Interface Deadline_for_notification_of_acceptance : Inherits Deadline
			
		End Interface
	#End Region

	#Region " Interface Tutorial_speaker "
		Interface Tutorial_speaker : Inherits Author
			
		End Interface
	#End Region

	#Region " Interface Session "
		Interface Session : Inherits Lecture, Scientific_Event
			
		End Interface
	#End Region

	#Region " Interface Registation_deadline "
		Interface Registation_deadline : Inherits Deadline
			
		End Interface
	#End Region

	#Region " Interface Single_hotel_room "
		Interface Single_hotel_room : Inherits Hotel_room
			
		End Interface
	#End Region

	#Region " Interface Non_speaker "
		Interface Non_speaker : Inherits Delegate
			
		End Interface
	#End Region

	#Region " Interface Author_information_form "
		Interface Author_information_form : Inherits Form
			
		End Interface
	#End Region

	#Region " Interface Nonmember_registration_fee "
		Interface Nonmember_registration_fee : Inherits Registration_fee
			
		End Interface
	#End Region

	#Region " Interface IASTED_non_member "
		Interface IASTED_non_member : Inherits Delegate
			
		End Interface
	#End Region

	#Region " Interface Hotel_fee "
		Interface Hotel_fee : Inherits Fee
			
		End Interface
	#End Region

	#Region " Interface Fee "
		Interface Fee : Inherits Money
			
		End Interface
	#End Region

	#Region " Interface Publication "
		Interface Publication : Inherits Item
			
		End Interface
	#End Region

	#Region " Interface Taxi "
		Interface Taxi : Inherits Transport_vehicle
			
		End Interface
	#End Region

	#Region " Interface Sponsor_state "
		Interface Sponsor_state : Inherits State
	...
	#Region " Interface Review "
		Interface Review : Inherits article, Conference_document, Document
			...
			''' <summary>
			''' reviewOfPaper oppositeOf hasReview
			''' </summary>
			Property reviewOfPaper As [[Paper]]

			Property reviewWrittenBy As [[Possible_Reviewer]]
		End Interface
	#End Region

	#Region " Interface Modelling "
		Interface Modelling : Inherits Research
			
		End Interface
	#End Region

	#Region " Interface Worker_non_speaker "
		Interface Worker_non_speaker : Inherits Non_speaker
			
		End Interface
	#End Region

	#Region " Interface Nonauthor_registration_fee "
		Interface Nonauthor_registration_fee : Inherits Registration_fee
			
		End Interface
	#End Region

	#Region " Interface Payment_document "
		Interface Payment_document : Inherits Document
			
		End Interface
	#End Region

	#Region " Interface Camera_ready_manuscript_deadline "
		Interface Camera_ready_manuscript_deadline : Inherits Deadline
			
		End Interface
	#End Region

	#Region " Interface One_conference_day "
		Interface One_conference_day : Inherits Conference_days
			
		End Interface
	#End Region

	#Region " Interface Fee_for_extra_trip "
		Interface Fee_for_extra_trip : Inherits Fee
			
		End Interface
	#End Region

	#Region " Interface Full_day_tour "
		Interface Full_day_tour : Inherits Activity_after_conference
			
		End Interface
	#End Region

	#Region " Interface Conference_Hiker "
		Interface Conference_Hiker : Inherits Delegate
			
		End Interface
	#End Region

	#Region " Interface Computer "
		Interface Computer : Inherits Audiovisual_equipment
			
		End Interface
	#End Region

	#Region " Interface IASTED_member "
		Interface IASTED_member : Inherits Delegate
			
		End Interface
	#End Region

	#Region " Interface Memeber_registration_fee "
		Interface Memeber_registration_fee : Inherits Registration_fee
			
		End Interface
	#End Region

	#Region " Interface Author_book_proceedings_included "
		Interface Author_book_proceedings_included : Inherits Author
			
		End Interface
	#End Region

	#Region " Interface Sponsor_company_house "
		Interface Sponsor_company_house : Inherits Building
			
		End Interface
	#End Region

	#Region " Interface Sponzorship "
		Interface Sponzorship : Inherits Money
			
		End Interface
	#End Region

	#Region " Interface Student_lecturer "
		Interface Student_lecturer : Inherits Lecturer
			
		End Interface
	#End Region

	#Region " Interface Trip_city "
		Interface Trip_city : Inherits City
			
		End Interface
	#End Region

	#Region " Interface Cheque "
		Interface Cheque : Inherits Payment_document
			
		End Interface
	#End Region

	#Region " Interface Shuttle_bus "
		Interface Shuttle_bus : Inherits Transport_vehicle
			
		End Interface
	#End Region

	#Region " Interface Student_non_speaker "
		Interface Student_non_speaker : Inherits Non_speaker
			
		End Interface
	#End Region

	#Region " Interface Student_registration_fee "
		Interface Student_registration_fee : Inherits Registration_fee
			
		End Interface
	#End Region

	#Region " Interface Author_attendee_cd_registration_fee "
		Interface Author_attendee_cd_registration_fee : Inherits Registration_fee
			
		End Interface
	#End Region

	#Region " Interface Tip "
		Interface Tip : Inherits Money
			
		End Interface
	#End Region

	#Region " Interface Credit_card "
		Interface Credit_card : Inherits Card
			
		End Interface
	#End Region

	#Region " Interface Van "
		Interface Van : Inherits Transport_vehicle
			
		End Interface
	#End Region

	#Region " Interface Main_office "
		Interface Main_office : Inherits Place
			
		End Interface
	#End Region

	#Region " Interface Presenter_university "
		Interface Presenter_university : Inherits Building
			
		End Interface
	#End Region

	#Region " Interface Departure_tax "
		Interface Departure_tax : Inherits Tax
			
		End Interface
	#End Region

	#Region " Interface Receiving_manuscript "
		Interface Receiving_manuscript : Inherits Activity_before_conference
			
		End Interface
	#End Region

	#Region " Interface Double_hotel_room "
		Interface Double_hotel_room : Inherits Hotel_room
			
		End Interface
	#End Region

	#Region " Interface Initial_manuscipt "
		Interface Initial_manuscipt : Inherits Submission
			
		End Interface
	#End Region

	#Region " Interface Coffee_break "
		Interface Coffee_break : Inherits Conference_activity
			
		End Interface
	#End Region

	#Region " Interface Bank_transfer "
		Interface Bank_transfer : Inherits Payment_document
			
		End Interface
	#End Region

	#Region " Interface Overhead_projector "
		Interface Overhead_projector : Inherits Audiovisual_equipment
			
		End Interface
	#End Region

	#Region " Interface Speaker_lecture "
		Interface Speaker_lecture : Inherits Session
			
		End Interface
	#End Region

	#Region " Interface Coctail_reception "
		Interface Coctail_reception : Inherits Conference_activity
			
		End Interface
	#End Region

	#Region " Interface Currency "
		Interface Currency
