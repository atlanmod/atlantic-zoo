...
CREATE TABLE NCName (
	__IDNCName__ Integer NOT NULL,
	value text,
	PRIMARY KEY NCName (__IDNCName__)
) ;
...
CREATE TABLE Reference (
	...
	FOREIGN KEY instance (__FKinstance__) REFERENCES Node (__IDNode__),
	FOREIGN KEY ref (__FKref__) REFERENCES NCName (__IDNCName__),
	FOREIGN KEY importnode (__FKimportnode__) REFERENCES ImportNode (__IDImportNode__),
	PRIMARY KEY Reference (__IDReference__),
	__FKref__ Integer,
	__FKinstance__ Integer,
	__FKimportnode__ Integer
) ;
...
CREATE TABLE Instance (
	...
	FOREIGN KEY ref (__FKref__) REFERENCES URI (__IDURI__),
	PRIMARY KEY Instance (__IDInstance__),
	__FKref__ Integer
) ;

CREATE TABLE ImportNode (
	__IDImportNode__ Integer NOT NULL,
	FOREIGN KEY parameter (__FKparameter__) REFERENCES NCName (__IDNCName__),
	FOREIGN KEY ref (__FKref__) REFERENCES Reference (__IDReference__),
	FOREIGN KEY instanceplace (__FKinstanceplace__) REFERENCES Instance (__IDInstance__),
	FOREIGN KEY instancetransition (__FKinstancetransition__) REFERENCES Instance (__IDInstance__),
	PRIMARY KEY ImportNode (__IDImportNode__),
	__FKref__ Integer,
	__FKinstancetransition__ Integer,
	__FKparameter__ Integer,
	__FKinstanceplace__ Integer
) ;
...
CREATE TABLE PNMLDocument_modules_Module (
	__IDPNMLDocument__ Integer NOT NULL,
	__IDModule__ Integer NOT NULL
) ;
...
CREATE TABLE Interface_exporttransition_Reference (
	__IDInterface__ Integer NOT NULL,
	__IDReference__ Integer NOT NULL
) ;

CREATE TABLE Interface_exportplace_Reference (
	__IDInterface__ Integer NOT NULL,
	__IDReference__ Integer NOT NULL
) ;
...
CREATE TABLE Instance_importplace_ImportNode (
	__IDInstance__ Integer NOT NULL,
	__IDImportNode__ Integer NOT NULL
) ;
...
CREATE TABLE Instance_importtransition_ImportNode (
	__IDInstance__ Integer NOT NULL,
	__IDImportNode__ Integer NOT NULL
) ;

CREATE TABLE Module_interfaces_Interface (
	__IDModule__ Integer NOT NULL,
	__IDInterface__ Integer NOT NULL
) ;
...
CREATE TABLE Interface_importtransition_Node (
	__IDInterface__ Integer NOT NULL,
	__IDNode__ Integer NOT NULL
) ;

CREATE TABLE Interface_importplace_Node (
	__IDInterface__ Integer NOT NULL,
	__IDNode__ Integer NOT NULL
) ;

CREATE TABLE Module_netcontents_NetContent (
	__IDModule__ Integer NOT NULL,
	__IDNetContent__ Integer NOT NULL
) ;
