...
CREATE TABLE PassiveObject (
	__IDPassiveObject__ Integer NOT NULL,
	PRIMARY KEY PassiveObject (__IDPassiveObject__)
) ;
...
CREATE TABLE Software (
	__IDSoftware__ Integer NOT NULL,
	PRIMARY KEY Software (__IDSoftware__)
) ;
...
CREATE TABLE Resource_commitment_Commitment (
	__IDResource__ Integer NOT NULL,
	__IDCommitment__ Integer NOT NULL
) ;
...
CREATE TABLE Commitment_resource_Resource (
	__IDCommitment__ Integer NOT NULL,
	__IDResource__ Integer NOT NULL
) ;
