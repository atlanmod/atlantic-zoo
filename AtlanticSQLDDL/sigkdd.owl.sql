...
CREATE TABLE Reviewer (
	...
	FOREIGN KEY executes (__FKexecutes__) REFERENCES DoubleBlindReview (__IDDoubleBlindReview__),
	FOREIGN KEY cooperates (__FKcooperates__) REFERENCES ExternalReviewer (__IDExternalReviewer__),
	FOREIGN KEY IsAssignedTo (__FKIsAssignedTo__) REFERENCES Paper (__IDPaper__),
	FOREIGN KEY hasConflictedPaper (__FKhasConflictedPaper__) REFERENCES Paper (__IDPaper__),
	FOREIGN KEY hasPreferredPaper (__FKhasPreferredPaper__) REFERENCES Paper (__IDPaper__),
	FOREIGN KEY hasPreferredTopic (__FKhasPreferredTopic__) REFERENCES ResearchTopic (__IDResearchTopic__),
	FOREIGN KEY writeReview (__FKwriteReview__) REFERENCES Review (__IDReview__),
	FOREIGN KEY has_made_review (__FKhas_made_review__) REFERENCES Paper_Review (__IDPaper_Review__),
	UserName text,
	Comments_to_Chair text,
	Other_Areas text,
	FOREIGN KEY refuses (__FKrefuses__) REFERENCES Pending_Proposed_Conflict (__IDPending_Proposed_Conflict__),
	FOREIGN KEY reviews (__FKreviews__) REFERENCES Paper (__IDPaper__),
	FOREIGN KEY bidsFor (__FKbidsFor__) REFERENCES Paper (__IDPaper__),
	FOREIGN KEY confirmes (__FKconfirmes__) REFERENCES Pending_Proposed_Conflict (__IDPending_Proposed_Conflict__),
	FOREIGN KEY assignedPaperBy (__FKassignedPaperBy__) REFERENCES Program_Comitee_Chair (__IDProgram_Comitee_Chair__),
	...
	__FKexecutes__ Integer,
	__FKcooperates__ Integer,
	__FKIsAssignedTo__ Integer,
	__FKhasConflictedPaper__ Integer,
	__FKhasPreferredPaper__ Integer,
	__FKhasPreferredTopic__ Integer,
	__FKwriteReview__ Integer,
	__FKhas_made_review__ Integer,
	__FKrefuses__ Integer,
	__FKreviews__ Integer,
	__FKbidsFor__ Integer,
	__FKconfirmes__ Integer,
	__FKassignedPaperBy__ Integer,
...
CREATE TABLE Person (
	...
	FOREIGN KEY pay (__FKpay__) REFERENCES Registration_fee (__IDRegistration_fee__),
	FOREIGN KEY can_stay_in (__FKcan_stay_in__) REFERENCES Place (__IDPlace__),
	Nation text,
	Name text,
	hasEmail text,
	hasName text,
	...
	FOREIGN KEY loggin_in (__FKloggin_in__) REFERENCES System (__IDSystem__),
	FOREIGN KEY submit (__FKsubmit__) REFERENCES Document (__IDDocument__),
	FOREIGN KEY get (__FKget__) REFERENCES Email (__IDEmail__),
	"E-mail" text,
...
CREATE TABLE ProgramCommittee (
	...
	FOREIGN KEY hasMember (__FKhasMember__) REFERENCES ProgramCommitteeMember (__IDProgramCommitteeMember__),
...
CREATE TABLE Conference (
	...
	FOREIGN KEY isOrganizedBy (__FKisOrganizedBy__) REFERENCES OrganizingCommittee (__IDOrganizingCommittee__),
	annualOrder Integer,
	FOREIGN KEY takesPlace (__FKtakesPlace__) REFERENCES Location (__IDLocation__),
	hasAcronym text,
	FOREIGN KEY finishedBy (__FKfinishedBy__) REFERENCES Program_Comitee_Chair (__IDProgram_Comitee_Chair__),
	FOREIGN KEY focusesOn (__FKfocusesOn__) REFERENCES Topic (__IDTopic__),
	FOREIGN KEY startedBy (__FKstartedBy__) REFERENCES Program_Comitee_Chair (__IDProgram_Comitee_Chair__),
	FOREIGN KEY takesPlace (__FKtakesPlace__) REFERENCES Location (__IDLocation__),
	FOREIGN KEY has_conference_member (__FKhas_conference_member__) REFERENCES ConferenceMember (__IDConferenceMember__),
	WebSite text,
	Topic_of_conference text,
	Date text,
	FOREIGN KEY holded_by (__FKholded_by__) REFERENCES ACM_SIGKDD (__IDACM_SIGKDD__),
	Name_of_conference text,
	Start_of_conference text,
	City_of_conference text,
	End_of_conference text,
	...
	__FKisOrganizedBy__ Integer,
	__FKtakesPlace__ Integer,
	__FKfinishedBy__ Integer,
	__FKfocusesOn__ Integer,
	__FKstartedBy__ Integer,
	__FKtakesPlace__ Integer,
	__FKhas_conference_member__ Integer,
	__FKholded_by__ Integer,
...
CREATE TABLE ConferenceMember (
	...
	FOREIGN KEY member_of_conference (__FKmember_of_conference__) REFERENCES Conference (__IDConference__),
	PRIMARY KEY ConferenceMember (__IDConferenceMember__),
	__FKmemberOfConference__ Integer,
	__FKmember_of_conference__ Integer
) ;
...
CREATE TABLE ProgramCommitteeMember (
	...
	FOREIGN KEY isMemberOf (__FKisMemberOf__) REFERENCES ProgramCommittee (__IDProgramCommittee__),
	hasPassword text,
...
CREATE TABLE Paper (
	...
	FOREIGN KEY paperIsSubmittedBy (__FKpaperIsSubmittedBy__) REFERENCES Author (__IDAuthor__),
	FOREIGN KEY isRejectedBy (__FKisRejectedBy__) REFERENCES Chair (__IDChair__),
	FOREIGN KEY isAcceptedBy (__FKisAcceptedBy__) REFERENCES Chair (__IDChair__),
	FOREIGN KEY paperIsAssignedTo (__FKpaperIsAssignedTo__) REFERENCES Reviewer (__IDReviewer__),
	FOREIGN KEY hasSecondaryTopic (__FKhasSecondaryTopic__) REFERENCES ResearchTopic (__IDResearchTopic__),
	FOREIGN KEY hasMainTopic (__FKhasMainTopic__) REFERENCES ResearchTopic (__IDResearchTopic__),
	FOREIGN KEY hasAuthor (__FKhasAuthor__) REFERENCES Author (__IDAuthor__),
	FOREIGN KEY hasStatus (__FKhasStatus__) REFERENCES PaperStatus (__IDPaperStatus__),
	hasTitle text,
	hasID text,
	FOREIGN KEY hasAbstract (__FKhasAbstract__) REFERENCES PaperAbstract (__IDPaperAbstract__),
	FOREIGN KEY isRatedBy (__FKisRatedBy__) REFERENCES Review (__IDReview__),
	FOREIGN KEY is_written_by (__FKis_written_by__) REFERENCES Author (__IDAuthor__),
	Abstract text,
	Title text,
	Students text,
	Keywords text,
	FOREIGN KEY rejectedBy (__FKrejectedBy__) REFERENCES Program_Comitee_Chair (__IDProgram_Comitee_Chair__),
	FOREIGN KEY acceptedBy (__FKacceptedBy__) REFERENCES Program_Comitee_Chair (__IDProgram_Comitee_Chair__),
	FOREIGN KEY reviewedBy (__FKreviewedBy__) REFERENCES Reviewer (__IDReviewer__),
	FOREIGN KEY discussedBy (__FKdiscussedBy__) REFERENCES Program_Comitee (__IDProgram_Comitee__),
	isPaperTypeOf text,
	FOREIGN KEY assignedToReviewBy (__FKassignedToReviewBy__) REFERENCES Program_Comitee_Chair (__IDProgram_Comitee_Chair__),
	hasBid text,
	Title text,
	Summary text,
	FOREIGN KEY rejected_paper_by (__FKrejected_paper_by__) REFERENCES CommitteeMember (__IDCommitteeMember__),
	FOREIGN KEY accepted_by (__FKaccepted_by__) REFERENCES CommitteeMember (__IDCommitteeMember__),
	FOREIGN KEY written_paper_by (__FKwritten_paper_by__) REFERENCES Author (__IDAuthor__),
	...
	__FKpaperIsSubmittedBy__ Integer,
	__FKisRejectedBy__ Integer,
	__FKisAcceptedBy__ Integer,
	__FKpaperIsAssignedTo__ Integer,
	__FKhasSecondaryTopic__ Integer,
	__FKhasMainTopic__ Integer,
	__FKhasAuthor__ Integer,
	__FKhasStatus__ Integer,
	__FKhasAbstract__ Integer,
	__FKisRatedBy__ Integer,
	__FKis_written_by__ Integer,
	__FKrejectedBy__ Integer,
	__FKacceptedBy__ Integer,
	__FKreviewedBy__ Integer,
	__FKdiscussedBy__ Integer,
	__FKassignedToReviewBy__ Integer,
	__FKrejected_paper_by__ Integer,
	__FKaccepted_by__ Integer,
	__FKwritten_paper_by__ Integer,
...
CREATE TABLE Author (
	...
	FOREIGN KEY isAuthorOf (__FKisAuthorOf__) REFERENCES ActivitySubmissionForm (__IDActivitySubmissionForm__),
	FOREIGN KEY conducts (__FKconducts__) REFERENCES Thing (__IDThing__),
	FOREIGN KEY submitsPaper (__FKsubmitsPaper__) REFERENCES Paper (__IDPaper__),
	FOREIGN KEY writePaper (__FKwritePaper__) REFERENCES Paper (__IDPaper__),
	FOREIGN KEY writes_Paper (__FKwrites_Paper__) REFERENCES Paper (__IDPaper__),
	FOREIGN KEY changes (__FKchanges__) REFERENCES Contribution (__IDContribution__),
	FOREIGN KEY write_paper (__FKwrite_paper__) REFERENCES Paper (__IDPaper__),
	FOREIGN KEY obtain (__FKobtain__) REFERENCES Award (__IDAward__),
	FOREIGN KEY submit (__FKsubmit__) REFERENCES Paper (__IDPaper__),
	FOREIGN KEY notification_until (__FKnotification_until__) REFERENCES Deadline_Author_notification (__IDDeadline_Author_notification__),
	...
	__FKisAuthorOf__ Integer,
	__FKconducts__ Integer,
	__FKsubmitsPaper__ Integer,
	__FKwritePaper__ Integer,
	__FKwrites_Paper__ Integer,
	__FKchanges__ Integer,
	__FKwrite_paper__ Integer,
	__FKobtain__ Integer,
	__FKsubmit__ Integer,
	__FKnotification_until__ Integer,
...
CREATE TABLE Administrator (
	...
	FOREIGN KEY assigns (__FKassigns__) REFERENCES Thing (__IDThing__),
	FOREIGN KEY send (__FKsend__) REFERENCES Email (__IDEmail__),
	FOREIGN KEY generate (__FKgenerate__) REFERENCES Thing (__IDThing__),
	...
	__FKassigns__ Integer,
	__FKsend__ Integer,
	__FKgenerate__ Integer,
...
CREATE TABLE Document (
	...
	FOREIGN KEY submited_by (__FKsubmited_by__) REFERENCES Person (__IDPerson__),
	Document_ID text,
	FOREIGN KEY presentationed_by (__FKpresentationed_by__) REFERENCES Speaker (__IDSpeaker__),
	FOREIGN KEY submit_until (__FKsubmit_until__) REFERENCES Deadline (__IDDeadline__),
	...
	__FKsubmited_by__ Integer,
	__FKpresentationed_by__ Integer,
	__FKsubmit_until__ Integer,
...
CREATE TABLE Email (
	...
	FOREIGN KEY sended_by (__FKsended_by__) REFERENCES Administrator (__IDAdministrator__),
	Receiver_of_email text,
	Message_of_email text,
	Subject_of_email text,
	PRIMARY KEY Email (__IDEmail__),
	__FKsended_by__ Integer
) ;
...
CREATE TABLE Activity (
	...
	FOREIGN KEY is_held_in (__FKis_held_in__) REFERENCES Thing (__IDThing__),
	...
	FOREIGN KEY isPartOf (__FKisPartOf__) REFERENCES Conference (__IDConference__),
...
CREATE TABLE Chair (
	...
	FOREIGN KEY produces (__FKproduces__) REFERENCES OutputDocument (__IDOutputDocument__),
	FOREIGN KEY sets (__FKsets__) REFERENCES Thing (__IDThing__),
	FOREIGN KEY accepts (__FKaccepts__) REFERENCES Paper (__IDPaper__),
	FOREIGN KEY rejects (__FKrejects__) REFERENCES Paper (__IDPaper__),
	FOREIGN KEY asksForPreference (__FKasksForPreference__) REFERENCES Reviewer (__IDReviewer__),
	FOREIGN KEY isChairOf (__FKisChairOf__) REFERENCES Session (__IDSession__),
	...
	__FKproduces__ Integer,
	__FKsets__ Integer,
	__FKaccepts__ Integer,
	__FKrejects__ Integer,
	__FKasksForPreference__ Integer,
	__FKisChairOf__ Integer,
...
CREATE TABLE Topic (
	...
	FOREIGN KEY isIncluded (__FKisIncluded__) REFERENCES Activity (__IDActivity__),
...
CREATE TABLE Review (
	...
	FOREIGN KEY assigned_review_by (__FKassigned_review_by__) REFERENCES Primary_Reviewer (__IDPrimary_Reviewer__),
	FOREIGN KEY written_review_by (__FKwritten_review_by__) REFERENCES Reviewer (__IDReviewer__),
	...
	FOREIGN KEY containsEvaluation (__FKcontainsEvaluation__) REFERENCES Evaluation (__IDEvaluation__),
	FOREIGN KEY rates (__FKrates__) REFERENCES Paper (__IDPaper__),
	FOREIGN KEY isWritenBy (__FKisWritenBy__) REFERENCES Reviewer (__IDReviewer__),
	PRIMARY KEY Review (__IDReview__),
	__FKassigned_review_by__ Integer,
	__FKwritten_review_by__ Integer,
	__FKwrittenBy__ Integer,
	__FKreviews__ Integer,
	__FKgives_classification__ Integer,
	__FKis_created_in__ Integer,
	...
	__FKcontainsEvaluation__ Integer,
	__FKrates__ Integer,
	__FKisWritenBy__ Integer
) ;
...
CREATE TABLE Deadline (
	...
	FOREIGN KEY designed_by (__FKdesigned_by__) REFERENCES ACM_SIGKDD (__IDACM_SIGKDD__),
	Date text,
	done_till text,
	PRIMARY KEY Deadline (__IDDeadline__),
	__FKdesigned_by__ Integer
) ;
...
CREATE TABLE OrganizingCommittee (
	__IDOrganizingCommittee__ Integer NOT NULL,
	FOREIGN KEY organizes (__FKorganizes__) REFERENCES Conference (__IDConference__),
	PRIMARY KEY OrganizingCommittee (__IDOrganizingCommittee__),
	__FKorganizes__ Integer
) ;

CREATE TABLE ProgramCoChair (
	__IDProgramCoChair__ Integer NOT NULL,
	PRIMARY KEY ProgramCoChair (__IDProgramCoChair__)
) ;

CREATE TABLE PublicationsChair (
	__IDPublicationsChair__ Integer NOT NULL,
	PRIMARY KEY PublicationsChair (__IDPublicationsChair__)
) ;

CREATE TABLE OutsideReferee (
	__IDOutsideReferee__ Integer NOT NULL,
	PRIMARY KEY OutsideReferee (__IDOutsideReferee__)
) ;
...
CREATE TABLE ActivitySubmissionForm (
	__IDActivitySubmissionForm__ Integer NOT NULL,
	FOREIGN KEY isSubmittedBy (__FKisSubmittedBy__) REFERENCES Author (__IDAuthor__),
	FOREIGN KEY hasAuthor (__FKhasAuthor__) REFERENCES Author (__IDAuthor__),
	submissionDeadline text,
	PRIMARY KEY ActivitySubmissionForm (__IDActivitySubmissionForm__),
	__FKisSubmittedBy__ Integer,
	__FKhasAuthor__ Integer
) ;

CREATE TABLE WorkshopTutorialChair (
	__IDWorkshopTutorialChair__ Integer NOT NULL,
	PRIMARY KEY WorkshopTutorialChair (__IDWorkshopTutorialChair__)
) ;

CREATE TABLE DoubleBlindReview (
	__IDDoubleBlindReview__ Integer NOT NULL,
	FOREIGN KEY isExecutedBy (__FKisExecutedBy__) REFERENCES Reviewer (__IDReviewer__),
	PRIMARY KEY DoubleBlindReview (__IDDoubleBlindReview__),
	__FKisExecutedBy__ Integer
) ;

CREATE TABLE TutorialProposal (
	__IDTutorialProposal__ Integer NOT NULL,
	PRIMARY KEY TutorialProposal (__IDTutorialProposal__)
) ;

CREATE TABLE RegistrationChair (
	__IDRegistrationChair__ Integer NOT NULL,
	PRIMARY KEY RegistrationChair (__IDRegistrationChair__)
) ;

CREATE TABLE StudentAdvocate (
	__IDStudentAdvocate__ Integer NOT NULL,
	PRIMARY KEY StudentAdvocate (__IDStudentAdvocate__)
) ;

CREATE TABLE FinanceChair (
	__IDFinanceChair__ Integer NOT NULL,
	PRIMARY KEY FinanceChair (__IDFinanceChair__)
) ;

CREATE TABLE QualitatvieLecture (
	__IDQualitatvieLecture__ Integer NOT NULL,
	PRIMARY KEY QualitatvieLecture (__IDQualitatvieLecture__)
) ;

CREATE TABLE TraditionalLecture (
	__IDTraditionalLecture__ Integer NOT NULL,
	PRIMARY KEY TraditionalLecture (__IDTraditionalLecture__)
) ;

CREATE TABLE PaperSubmissionChair (
	__IDPaperSubmissionChair__ Integer NOT NULL,
	PRIMARY KEY PaperSubmissionChair (__IDPaperSubmissionChair__)
) ;

CREATE TABLE PublicityWebChair (
	__IDPublicityWebChair__ Integer NOT NULL,
	PRIMARY KEY PublicityWebChair (__IDPublicityWebChair__)
) ;

CREATE TABLE SteeringCommittee (
	__IDSteeringCommittee__ Integer NOT NULL,
	PRIMARY KEY SteeringCommittee (__IDSteeringCommittee__)
) ;

CREATE TABLE GeneralCoChair (
	__IDGeneralCoChair__ Integer NOT NULL,
	PRIMARY KEY GeneralCoChair (__IDGeneralCoChair__)
) ;

CREATE TABLE WorksopProposal (
	__IDWorksopProposal__ Integer NOT NULL,
	PRIMARY KEY WorksopProposal (__IDWorksopProposal__)
) ;
...
CREATE TABLE ExternalReviewer (
	...
	FOREIGN KEY cooperatesReviewer (__FKcooperatesReviewer__) REFERENCES Reviewer (__IDReviewer__),
	PRIMARY KEY ExternalReviewer (__IDExternalReviewer__),
	__FKassignedByReviewer__ Integer,
	__FKcooperatesReviewer__ Integer
) ;

CREATE TABLE ContactAuthor (
	__IDContactAuthor__ Integer NOT NULL,
	FOREIGN KEY submitsAbstract (__FKsubmitsAbstract__) REFERENCES PaperAbstract (__IDPaperAbstract__),
	PRIMARY KEY ContactAuthor (__IDContactAuthor__),
	__FKsubmitsAbstract__ Integer
) ;

CREATE TABLE ConferenceProgram (
	__IDConferenceProgram__ Integer NOT NULL,
	FOREIGN KEY isProgramOf (__FKisProgramOf__) REFERENCES Conference (__IDConference__),
	FOREIGN KEY consistsOf (__FKconsistsOf__) REFERENCES Slot (__IDSlot__),
	PRIMARY KEY ConferenceProgram (__IDConferenceProgram__),
	__FKisProgramOf__ Integer,
	__FKconsistsOf__ Integer
) ;

CREATE TABLE PaperStatus (
	__IDPaperStatus__ Integer NOT NULL,
	FOREIGN KEY isStatusOf (__FKisStatusOf__) REFERENCES Paper (__IDPaper__),
	PRIMARY KEY PaperStatus (__IDPaperStatus__),
	__FKisStatusOf__ Integer
) ;
...
CREATE TABLE Slot (
	...
	endsAt text,
	beginsAt text,
	FOREIGN KEY forms (__FKforms__) REFERENCES ConferenceProgram (__IDConferenceProgram__),
	FOREIGN KEY hosts (__FKhosts__) REFERENCES Session (__IDSession__),
...
CREATE TABLE Session (
	__IDSession__ Integer NOT NULL,
	FOREIGN KEY hasAssignedPaper (__FKhasAssignedPaper__) REFERENCES AcceptedPaper (__IDAcceptedPaper__),
	room text,
	FOREIGN KEY isAssociatedTo (__FKisAssociatedTo__) REFERENCES Slot (__IDSlot__),
	FOREIGN KEY hasChair (__FKhasChair__) REFERENCES Chair (__IDChair__),
	PRIMARY KEY Session (__IDSession__),
	__FKhasAssignedPaper__ Integer,
	__FKisAssociatedTo__ Integer,
	__FKhasChair__ Integer
) ;
...
CREATE TABLE PaymentMode (
	__IDPaymentMode__ Integer NOT NULL,
	PRIMARY KEY PaymentMode (__IDPaymentMode__)
) ;

CREATE TABLE OutputDocument (
	__IDOutputDocument__ Integer NOT NULL,
	FOREIGN KEY isProducedBy (__FKisProducedBy__) REFERENCES Chair (__IDChair__),
	PRIMARY KEY OutputDocument (__IDOutputDocument__),
	__FKisProducedBy__ Integer
) ;
...
CREATE TABLE AcceptedPaper (
	...
	FOREIGN KEY isAssignedToSession (__FKisAssignedToSession__) REFERENCES Session (__IDSession__),
	PRIMARY KEY AcceptedPaper (__IDAcceptedPaper__),
	__FKrelatedToEvent__ Integer,
	__FKisAssignedToSession__ Integer
) ;
...
CREATE TABLE ConferenceAttendant (
	__IDConferenceAttendant__ Integer NOT NULL,
	FOREIGN KEY mustPay (__FKmustPay__) REFERENCES Fee (__IDFee__),
	hasAdress text,
	paid Boolean,
	hasPhone text,
	PRIMARY KEY ConferenceAttendant (__IDConferenceAttendant__),
	__FKmustPay__ Integer
) ;

CREATE TABLE Evaluation (
	__IDEvaluation__ Integer NOT NULL,
	FOREIGN KEY isContainedIn (__FKisContainedIn__) REFERENCES Review (__IDReview__),
	PRIMARY KEY Evaluation (__IDEvaluation__),
	__FKisContainedIn__ Integer
) ;

CREATE TABLE PaperAbstract (
	__IDPaperAbstract__ Integer NOT NULL,
	FOREIGN KEY isAbstractOf (__FKisAbstractOf__) REFERENCES Paper (__IDPaper__),
	FOREIGN KEY abstractIsSubmittedBy (__FKabstractIsSubmittedBy__) REFERENCES ContactAuthor (__IDContactAuthor__),
	PRIMARY KEY PaperAbstract (__IDPaperAbstract__),
	__FKisAbstractOf__ Integer,
	__FKabstractIsSubmittedBy__ Integer
) ;
...
CREATE TABLE PaperQuestion (
	__IDPaperQuestion__ Integer NOT NULL,
	PRIMARY KEY PaperQuestion (__IDPaperQuestion__)
) ;

CREATE TABLE "CD-ROM" (
	"__IDCD-ROM__" Integer NOT NULL,
	PRIMARY KEY "CD-ROM" ("__IDCD-ROM__")
) ;

CREATE TABLE IndexOfAuthors (
	__IDIndexOfAuthors__ Integer NOT NULL,
	PRIMARY KEY IndexOfAuthors (__IDIndexOfAuthors__)
) ;

CREATE TABLE ExternalReviewersList (
	__IDExternalReviewersList__ Integer NOT NULL,
	PRIMARY KEY ExternalReviewersList (__IDExternalReviewersList__)
) ;
...
CREATE TABLE PCMembersList (
	__IDPCMembersList__ Integer NOT NULL,
	PRIMARY KEY PCMembersList (__IDPCMembersList__)
) ;

CREATE TABLE ListOfAbstracts (
	__IDListOfAbstracts__ Integer NOT NULL,
	PRIMARY KEY ListOfAbstracts (__IDListOfAbstracts__)
) ;

CREATE TABLE BookletOfAbstracts (
	__IDBookletOfAbstracts__ Integer NOT NULL,
	PRIMARY KEY BookletOfAbstracts (__IDBookletOfAbstracts__)
) ;

CREATE TABLE RFC (
	__IDRFC__ Integer NOT NULL,
	PRIMARY KEY RFC (__IDRFC__)
) ;

CREATE TABLE Topics (
	__IDTopics__ Integer NOT NULL,
	PRIMARY KEY Topics (__IDTopics__)
) ;

CREATE TABLE Classic_Papers (
	__IDClassic_Papers__ Integer NOT NULL,
	PRIMARY KEY Classic_Papers (__IDClassic_Papers__)
) ;

CREATE TABLE Networking (
	__IDNetworking__ Integer NOT NULL,
	PRIMARY KEY Networking (__IDNetworking__)
) ;

CREATE TABLE Humour (
	__IDHumour__ Integer NOT NULL,
	PRIMARY KEY Humour (__IDHumour__)
) ;

CREATE TABLE Programming (
	__IDProgramming__ Integer NOT NULL,
	PRIMARY KEY Programming (__IDProgramming__)
) ;

CREATE TABLE Computer_Science (
	__IDComputer_Science__ Integer NOT NULL,
	PRIMARY KEY Computer_Science (__IDComputer_Science__)
) ;
...
CREATE TABLE Value_Partition (
	__IDValue_Partition__ Integer NOT NULL,
	PRIMARY KEY Value_Partition (__IDValue_Partition__)
) ;

CREATE TABLE Adobe_PDF (
	__IDAdobe_PDF__ Integer NOT NULL,
	PRIMARY KEY Adobe_PDF (__IDAdobe_PDF__)
) ;

CREATE TABLE MS_Word (
	__IDMS_Word__ Integer NOT NULL,
	PRIMARY KEY MS_Word (__IDMS_Word__)
) ;

CREATE TABLE Corel_Word_Perfect (
	__IDCorel_Word_Perfect__ Integer NOT NULL,
	PRIMARY KEY Corel_Word_Perfect (__IDCorel_Word_Perfect__)
) ;
...
CREATE TABLE PostScript (
	__IDPostScript__ Integer NOT NULL,
	PRIMARY KEY PostScript (__IDPostScript__)
) ;

CREATE TABLE RTF (
	__IDRTF__ Integer NOT NULL,
	PRIMARY KEY RTF (__IDRTF__)
) ;
...
CREATE TABLE High (
	__IDHigh__ Integer NOT NULL,
	PRIMARY KEY High (__IDHigh__)
) ;

CREATE TABLE Reviewer_Famliliarity (
	__IDReviewer_Famliliarity__ Integer NOT NULL,
	PRIMARY KEY Reviewer_Famliliarity (__IDReviewer_Famliliarity__)
) ;

CREATE TABLE Low (
	__IDLow__ Integer NOT NULL,
	PRIMARY KEY Low (__IDLow__)
) ;

CREATE TABLE Moderate (
	__IDModerate__ Integer NOT NULL,
	PRIMARY KEY Moderate (__IDModerate__)
) ;

CREATE TABLE Marginal_Tend_to_Reject (
	__IDMarginal_Tend_to_Reject__ Integer NOT NULL,
	PRIMARY KEY Marginal_Tend_to_Reject (__IDMarginal_Tend_to_Reject__)
) ;

CREATE TABLE Reccommendation (
	__IDReccommendation__ Integer NOT NULL,
	PRIMARY KEY Reccommendation (__IDReccommendation__)
) ;

CREATE TABLE Marginal_Tend_to_Accept (
	__IDMarginal_Tend_to_Accept__ Integer NOT NULL,
	PRIMARY KEY Marginal_Tend_to_Accept (__IDMarginal_Tend_to_Accept__)
) ;

CREATE TABLE Portable_Reject (
	__IDPortable_Reject__ Integer NOT NULL,
	PRIMARY KEY Portable_Reject (__IDPortable_Reject__)
) ;

CREATE TABLE Must_Accept (
	__IDMust_Accept__ Integer NOT NULL,
	PRIMARY KEY Must_Accept (__IDMust_Accept__)
) ;

CREATE TABLE Clear_Reject (
	__IDClear_Reject__ Integer NOT NULL,
	PRIMARY KEY Clear_Reject (__IDClear_Reject__)
) ;

CREATE TABLE Clear_Accept (
	__IDClear_Accept__ Integer NOT NULL,
	PRIMARY KEY Clear_Accept (__IDClear_Accept__)
) ;

CREATE TABLE Program_chair (
	__IDProgram_chair__ Integer NOT NULL,
	FOREIGN KEY made_program (__FKmade_program__) REFERENCES Conference_Program (__IDConference_Program__),
	PRIMARY KEY Program_chair (__IDProgram_chair__),
	__FKmade_program__ Integer
) ;

CREATE TABLE Conference_Program (
	__IDConference_Program__ Integer NOT NULL,
	FOREIGN KEY Program_made_by (__FKProgram_made_by__) REFERENCES Program_chair (__IDProgram_chair__),
	FOREIGN KEY planned_papers (__FKplanned_papers__) REFERENCES Planed_Paper (__IDPlaned_Paper__),
	PRIMARY KEY Conference_Program (__IDConference_Program__),
	__FKProgram_made_by__ Integer,
	__FKplanned_papers__ Integer
) ;
...
CREATE TABLE Domain_Topic (
	__IDDomain_Topic__ Integer NOT NULL,
	PRIMARY KEY Domain_Topic (__IDDomain_Topic__)
) ;

CREATE TABLE Planed_Paper (
	__IDPlaned_Paper__ Integer NOT NULL,
	FOREIGN KEY is_planned_in (__FKis_planned_in__) REFERENCES Conference_Program (__IDConference_Program__),
	PRIMARY KEY Planed_Paper (__IDPlaned_Paper__),
	__FKis_planned_in__ Integer
) ;

CREATE TABLE Valuable_Confirmation_of_Present_Knowledge (
	__IDValuable_Confirmation_of_Present_Knowledge__ Integer NOT NULL,
	PRIMARY KEY Valuable_Confirmation_of_Present_Knowledge (__IDValuable_Confirmation_of_Present_Knowledge__)
) ;
...
CREATE TABLE Not_Much (
	__IDNot_Much__ Integer NOT NULL,
	PRIMARY KEY Not_Much (__IDNot_Much__)
) ;

CREATE TABLE New_Information (
	__IDNew_Information__ Integer NOT NULL,
	PRIMARY KEY New_Information (__IDNew_Information__)
) ;

CREATE TABLE New_Perspective_Issue_Problem_Solving (
	__IDNew_Perspective_Issue_Problem_Solving__ Integer NOT NULL,
	PRIMARY KEY New_Perspective_Issue_Problem_Solving (__IDNew_Perspective_Issue_Problem_Solving__)
) ;

CREATE TABLE Clarity_to_Present_Understanding (
	__IDClarity_to_Present_Understanding__ Integer NOT NULL,
	PRIMARY KEY Clarity_to_Present_Understanding (__IDClarity_to_Present_Understanding__)
) ;

CREATE TABLE Overall_Value (
	__IDOverall_Value__ Integer NOT NULL,
	PRIMARY KEY Overall_Value (__IDOverall_Value__)
) ;

CREATE TABLE Tends_Towards_Theoretical (
	__IDTends_Towards_Theoretical__ Integer NOT NULL,
	PRIMARY KEY Tends_Towards_Theoretical (__IDTends_Towards_Theoretical__)
) ;

CREATE TABLE Paper_Categorization (
	__IDPaper_Categorization__ Integer NOT NULL,
	PRIMARY KEY Paper_Categorization (__IDPaper_Categorization__)
) ;

CREATE TABLE Tends_Towards_Practical (
	__IDTends_Towards_Practical__ Integer NOT NULL,
	PRIMARY KEY Tends_Towards_Practical (__IDTends_Towards_Practical__)
) ;

CREATE TABLE Balanced_Theory_and_Practice (
	__IDBalanced_Theory_and_Practice__ Integer NOT NULL,
	PRIMARY KEY Balanced_Theory_and_Practice (__IDBalanced_Theory_and_Practice__)
) ;

CREATE TABLE Highly_Theoretical (
	__IDHighly_Theoretical__ Integer NOT NULL,
	PRIMARY KEY Highly_Theoretical (__IDHighly_Theoretical__)
) ;

CREATE TABLE Highly_Practical (
	__IDHighly_Practical__ Integer NOT NULL,
	PRIMARY KEY Highly_Practical (__IDHighly_Practical__)
) ;

CREATE TABLE Reviewed_Paper (
	__IDReviewed_Paper__ Integer NOT NULL,
	PRIMARY KEY Reviewed_Paper (__IDReviewed_Paper__)
) ;

CREATE TABLE Submitted_Paper (
	__IDSubmitted_Paper__ Integer NOT NULL,
	FOREIGN KEY is_stored_in (__FKis_stored_in__) REFERENCES Paper_File (__IDPaper_File__),
	FOREIGN KEY has_been_sent_by (__FKhas_been_sent_by__) REFERENCES Contact_Author (__IDContact_Author__),
	Paper_Id Integer,
	Comments_To_Chair text,
	PRIMARY KEY Submitted_Paper (__IDSubmitted_Paper__),
	__FKis_stored_in__ Integer,
	__FKhas_been_sent_by__ Integer
) ;

CREATE TABLE Paper_Review (
	__IDPaper_Review__ Integer NOT NULL,
	FOREIGN KEY is_Candidate_for_Award (__FKis_Candidate_for_Award__) REFERENCES Long_bool (__IDLong_bool__),
	FOREIGN KEY appropriate_length (__FKappropriate_length__) REFERENCES Long_bool (__IDLong_bool__),
	FOREIGN KEY has_Categorization (__FKhas_Categorization__) REFERENCES Paper_Categorization (__IDPaper_Categorization__),
	FOREIGN KEY has_Overall (__FKhas_Overall__) REFERENCES Overall_Value (__IDOverall_Value__),
	FOREIGN KEY has_Reccommendation (__FKhas_Reccommendation__) REFERENCES Reccommendation (__IDReccommendation__),
	FOREIGN KEY Review_made_by (__FKReview_made_by__) REFERENCES Reviewer (__IDReviewer__),
	Comments_for_Author text,
	Comments_for_Program_Committee text,
	PRIMARY KEY Paper_Review (__IDPaper_Review__),
	__FKis_Candidate_for_Award__ Integer,
	__FKappropriate_length__ Integer,
	__FKhas_Categorization__ Integer,
	__FKhas_Overall__ Integer,
	__FKhas_Reccommendation__ Integer,
	__FKReview_made_by__ Integer
) ;

CREATE TABLE Long_bool (
	__IDLong_bool__ Integer NOT NULL,
	PRIMARY KEY Long_bool (__IDLong_bool__)
) ;

CREATE TABLE Review_Values (
	__IDReview_Values__ Integer NOT NULL,
	PRIMARY KEY Review_Values (__IDReview_Values__)
) ;

CREATE TABLE Review_Committee (
	__IDReview_Committee__ Integer NOT NULL,
	PRIMARY KEY Review_Committee (__IDReview_Committee__)
) ;

CREATE TABLE Committees (
	__IDCommittees__ Integer NOT NULL,
	PRIMARY KEY Committees (__IDCommittees__)
) ;

CREATE TABLE Paper_File (
	__IDPaper_File__ Integer NOT NULL,
	FOREIGN KEY is_Type (__FKis_Type__) REFERENCES Format (__IDFormat__),
	PRIMARY KEY Paper_File (__IDPaper_File__),
	__FKis_Type__ Integer
) ;

CREATE TABLE Advocate (
	__IDAdvocate__ Integer NOT NULL,
	FOREIGN KEY will_advocate (__FKwill_advocate__) REFERENCES Advocated_Paper (__IDAdvocated_Paper__),
	PRIMARY KEY Advocate (__IDAdvocate__),
	__FKwill_advocate__ Integer
) ;

CREATE TABLE Advocated_Paper (
	__IDAdvocated_Paper__ Integer NOT NULL,
	FOREIGN KEY to_advocate_by (__FKto_advocate_by__) REFERENCES Advocate (__IDAdvocate__),
	PRIMARY KEY Advocated_Paper (__IDAdvocated_Paper__),
	__FKto_advocate_by__ Integer
) ;

CREATE TABLE Contact_Author (
	__IDContact_Author__ Integer NOT NULL,
	FOREIGN KEY has_sent (__FKhas_sent__) REFERENCES Submitted_Paper (__IDSubmitted_Paper__),
	Alternate_Email text,
	PRIMARY KEY Contact_Author (__IDContact_Author__),
	__FKhas_sent__ Integer
) ;

CREATE TABLE Result_of_Advocate (
	__IDResult_of_Advocate__ Integer NOT NULL,
	PRIMARY KEY Result_of_Advocate (__IDResult_of_Advocate__)
) ;

CREATE TABLE People (
	__IDPeople__ Integer NOT NULL,
	Surname text,
	Name text,
	Country text,
	"E-mail" text,
	Organisation text,
	PRIMARY KEY People (__IDPeople__)
) ;

CREATE TABLE Source_Archive (
	__IDSource_Archive__ Integer NOT NULL,
	PRIMARY KEY Source_Archive (__IDSource_Archive__)
) ;
...
CREATE TABLE Camera_Ready_Copy (
	__IDCamera_Ready_Copy__ Integer NOT NULL,
	PRIMARY KEY Camera_Ready_Copy (__IDCamera_Ready_Copy__)
) ;

CREATE TABLE Slides (
	__IDSlides__ Integer NOT NULL,
	PRIMARY KEY Slides (__IDSlides__)
) ;

CREATE TABLE Contribution_File (
	__IDContribution_File__ Integer NOT NULL,
	hasContributionFileStatus text,
	PRIMARY KEY Contribution_File (__IDContribution_File__)
) ;

CREATE TABLE Discussion (
	__IDDiscussion__ Integer NOT NULL,
	PRIMARY KEY Discussion (__IDDiscussion__)
) ;

CREATE TABLE PhaseOfConferencePreparation (
	__IDPhaseOfConferencePreparation__ Integer NOT NULL,
	hasPhaseStatus text,
	PRIMARY KEY PhaseOfConferencePreparation (__IDPhaseOfConferencePreparation__)
) ;

CREATE TABLE Program_Comitee (
	__IDProgram_Comitee__ Integer NOT NULL,
	FOREIGN KEY discusses (__FKdiscusses__) REFERENCES Paper (__IDPaper__),
	PRIMARY KEY Program_Comitee (__IDProgram_Comitee__),
	__FKdiscusses__ Integer
) ;
...
CREATE TABLE Contribution (
	...
	hasKeyword text,
	hasTitle text,
	FOREIGN KEY changedBy (__FKchangedBy__) REFERENCES Author (__IDAuthor__),
	hasContributionStatus text,
	PRIMARY KEY Contribution (__IDContribution__),
	__FKwrittenBy__ Integer,
	__FKdealsWith__ Integer,
	__FKchangedBy__ Integer
) ;

CREATE TABLE Conflict_Of_Interest (
	__IDConflict_Of_Interest__ Integer NOT NULL,
	PRIMARY KEY Conflict_Of_Interest (__IDConflict_Of_Interest__)
) ;

CREATE TABLE Conflict_Rules (
	__IDConflict_Rules__ Integer NOT NULL,
	PRIMARY KEY Conflict_Rules (__IDConflict_Rules__)
) ;

CREATE TABLE Program_Comitee_Meeting (
	__IDProgram_Comitee_Meeting__ Integer NOT NULL,
	PRIMARY KEY Program_Comitee_Meeting (__IDProgram_Comitee_Meeting__)
) ;

CREATE TABLE Setup_Phase (
	__IDSetup_Phase__ Integer NOT NULL,
	PRIMARY KEY Setup_Phase (__IDSetup_Phase__)
) ;

CREATE TABLE Camera_Ready_Copy_Phase (
	__IDCamera_Ready_Copy_Phase__ Integer NOT NULL,
	PRIMARY KEY Camera_Ready_Copy_Phase (__IDCamera_Ready_Copy_Phase__)
) ;

CREATE TABLE Assignment_Phase (
	__IDAssignment_Phase__ Integer NOT NULL,
	PRIMARY KEY Assignment_Phase (__IDAssignment_Phase__)
) ;

CREATE TABLE Blocked_Phase (
	__IDBlocked_Phase__ Integer NOT NULL,
	PRIMARY KEY Blocked_Phase (__IDBlocked_Phase__)
) ;

CREATE TABLE Abstract_And_Paper_Submission_Phase (
	__IDAbstract_And_Paper_Submission_Phase__ Integer NOT NULL,
	PRIMARY KEY Abstract_And_Paper_Submission_Phase (__IDAbstract_And_Paper_Submission_Phase__)
) ;

CREATE TABLE Invitation_Of_Reviewers_Phase (
	__IDInvitation_Of_Reviewers_Phase__ Integer NOT NULL,
	PRIMARY KEY Invitation_Of_Reviewers_Phase (__IDInvitation_Of_Reviewers_Phase__)
) ;

CREATE TABLE Review_Phase (
	__IDReview_Phase__ Integer NOT NULL,
	PRIMARY KEY Review_Phase (__IDReview_Phase__)
) ;

CREATE TABLE Closed_Phase (
	__IDClosed_Phase__ Integer NOT NULL,
	PRIMARY KEY Closed_Phase (__IDClosed_Phase__)
) ;

CREATE TABLE Bidding_Phase (
	__IDBidding_Phase__ Integer NOT NULL,
	PRIMARY KEY Bidding_Phase (__IDBidding_Phase__)
) ;

CREATE TABLE Speaker (
	__IDSpeaker__ Integer NOT NULL,
	FOREIGN KEY presentation (__FKpresentation__) REFERENCES Document (__IDDocument__),
	PRIMARY KEY Speaker (__IDSpeaker__),
	__FKpresentation__ Integer
) ;

CREATE TABLE Program_Comitee_Chair (
	__IDProgram_Comitee_Chair__ Integer NOT NULL,
	FOREIGN KEY finishes (__FKfinishes__) REFERENCES Conference (__IDConference__),
	FOREIGN KEY headOf (__FKheadOf__) REFERENCES Program_Comitee (__IDProgram_Comitee__),
	FOREIGN KEY switches (__FKswitches__) REFERENCES PhaseOfConferencePreparation (__IDPhaseOfConferencePreparation__),
	FOREIGN KEY starts (__FKstarts__) REFERENCES Conference (__IDConference__),
	FOREIGN KEY accepts (__FKaccepts__) REFERENCES Paper (__IDPaper__),
	FOREIGN KEY assignsToReview (__FKassignsToReview__) REFERENCES Paper (__IDPaper__),
	FOREIGN KEY assignsPaper (__FKassignsPaper__) REFERENCES Reviewer (__IDReviewer__),
	FOREIGN KEY rejects (__FKrejects__) REFERENCES Paper (__IDPaper__),
	PRIMARY KEY Program_Comitee_Chair (__IDProgram_Comitee_Chair__),
	__FKfinishes__ Integer,
	__FKheadOf__ Integer,
	__FKswitches__ Integer,
	__FKstarts__ Integer,
	__FKaccepts__ Integer,
	__FKassignsToReview__ Integer,
	__FKassignsPaper__ Integer,
	__FKrejects__ Integer
) ;

CREATE TABLE Confirmed_Conflict (
	__IDConfirmed_Conflict__ Integer NOT NULL,
	PRIMARY KEY Confirmed_Conflict (__IDConfirmed_Conflict__)
) ;

CREATE TABLE Pending_Proposed_Conflict (
	__IDPending_Proposed_Conflict__ Integer NOT NULL,
	FOREIGN KEY refusedBy (__FKrefusedBy__) REFERENCES Reviewer (__IDReviewer__),
	FOREIGN KEY confirmedBy (__FKconfirmedBy__) REFERENCES Reviewer (__IDReviewer__),
	PRIMARY KEY Pending_Proposed_Conflict (__IDPending_Proposed_Conflict__),
	__FKrefusedBy__ Integer,
	__FKconfirmedBy__ Integer
) ;

CREATE TABLE Hidden_Conflict (
	__IDHidden_Conflict__ Integer NOT NULL,
	PRIMARY KEY Hidden_Conflict (__IDHidden_Conflict__)
) ;

CREATE TABLE Deleted_Conflict (
	__IDDeleted_Conflict__ Integer NOT NULL,
	PRIMARY KEY Deleted_Conflict (__IDDeleted_Conflict__)
) ;

CREATE TABLE Proposed_Conflict (
	__IDProposed_Conflict__ Integer NOT NULL,
	FOREIGN KEY conflictProposedBy (__FKconflictProposedBy__) REFERENCES Thing (__IDThing__),
	PRIMARY KEY Proposed_Conflict (__IDProposed_Conflict__),
	__FKconflictProposedBy__ Integer
) ;

CREATE TABLE Self_Conflict (
	__IDSelf_Conflict__ Integer NOT NULL,
	PRIMARY KEY Self_Conflict (__IDSelf_Conflict__)
) ;
...
CREATE TABLE MainAuthor (
	__IDMainAuthor__ Integer NOT NULL,
	PRIMARY KEY MainAuthor (__IDMainAuthor__)
) ;

CREATE TABLE Bidding_And_Paper_Submission_Phase (
	__IDBidding_And_Paper_Submission_Phase__ Integer NOT NULL,
	PRIMARY KEY Bidding_And_Paper_Submission_Phase (__IDBidding_And_Paper_Submission_Phase__)
) ;

CREATE TABLE Bidding_Without_Paper_Submission_Phase (
	__IDBidding_Without_Paper_Submission_Phase__ Integer NOT NULL,
	PRIMARY KEY Bidding_Without_Paper_Submission_Phase (__IDBidding_Without_Paper_Submission_Phase__)
) ;

CREATE TABLE "E-mail_PC_Meeting" (
	"__IDE-mail_PC_Meeting__" Integer NOT NULL,
	PRIMARY KEY "E-mail_PC_Meeting" ("__IDE-mail_PC_Meeting__")
) ;
...
CREATE TABLE External_Reviewer (
	__IDExternal_Reviewer__ Integer NOT NULL,
	PRIMARY KEY External_Reviewer (__IDExternal_Reviewer__)
) ;

CREATE TABLE Accepted_paper (
	__IDAccepted_paper__ Integer NOT NULL,
	FOREIGN KEY read_paper_by (__FKread_paper_by__) REFERENCES Thing (__IDThing__),
	FOREIGN KEY rateed_paper_by (__FKrateed_paper_by__) REFERENCES Thing (__IDThing__),
	Score text,
	PRIMARY KEY Accepted_paper (__IDAccepted_paper__),
	__FKread_paper_by__ Integer,
	__FKrateed_paper_by__ Integer
) ;
...
CREATE TABLE Secondary_Reviewer (
	__IDSecondary_Reviewer__ Integer NOT NULL,
	PRIMARY KEY Secondary_Reviewer (__IDSecondary_Reviewer__)
) ;

CREATE TABLE CommitteeMember (
	__IDCommitteeMember__ Integer NOT NULL,
	FOREIGN KEY isMemberOf (__FKisMemberOf__) REFERENCES Conference (__IDConference__),
	FOREIGN KEY reject_paper (__FKreject_paper__) REFERENCES Paper (__IDPaper__),
	FOREIGN KEY accept (__FKaccept__) REFERENCES Paper (__IDPaper__),
	PRIMARY KEY CommitteeMember (__IDCommitteeMember__),
	__FKisMemberOf__ Integer,
	__FKreject_paper__ Integer,
...
CREATE TABLE Electronic_proceeding (
	__IDElectronic_proceeding__ Integer NOT NULL,
	PRIMARY KEY Electronic_proceeding (__IDElectronic_proceeding__)
) ;
...
CREATE TABLE CD (
	__IDCD__ Integer NOT NULL,
	PRIMARY KEY CD (__IDCD__)
) ;

CREATE TABLE Invitation (
	__IDInvitation__ Integer NOT NULL,
	PRIMARY KEY Invitation (__IDInvitation__)
) ;
...
CREATE TABLE Primary_Reviewer (
	__IDPrimary_Reviewer__ Integer NOT NULL,
	FOREIGN KEY assign_review (__FKassign_review__) REFERENCES Review (__IDReview__),
	PRIMARY KEY Primary_Reviewer (__IDPrimary_Reviewer__),
	__FKassign_review__ Integer
) ;

CREATE TABLE Hotel (
	__IDHotel__ Integer NOT NULL,
	PRIMARY KEY Hotel (__IDHotel__)
) ;

CREATE TABLE Deadline_Abstract_Submission (
	__IDDeadline_Abstract_Submission__ Integer NOT NULL,
	PRIMARY KEY Deadline_Abstract_Submission (__IDDeadline_Abstract_Submission__)
) ;

CREATE TABLE Best_Applications_Paper_Award (
	__IDBest_Applications_Paper_Award__ Integer NOT NULL,
	PRIMARY KEY Best_Applications_Paper_Award (__IDBest_Applications_Paper_Award__)
) ;

CREATE TABLE Award (
	__IDAward__ Integer NOT NULL,
	PRIMARY KEY Award (__IDAward__)
) ;

CREATE TABLE Deadline_Paper_Submission (
	__IDDeadline_Paper_Submission__ Integer NOT NULL,
	PRIMARY KEY Deadline_Paper_Submission (__IDDeadline_Paper_Submission__)
) ;

CREATE TABLE Deadline_Author_notification (
	__IDDeadline_Author_notification__ Integer NOT NULL,
	PRIMARY KEY Deadline_Author_notification (__IDDeadline_Author_notification__)
) ;

CREATE TABLE Webmaster (
	__IDWebmaster__ Integer NOT NULL,
	PRIMARY KEY Webmaster (__IDWebmaster__)
) ;

CREATE TABLE Organizator (
	__IDOrganizator__ Integer NOT NULL,
	PRIMARY KEY Organizator (__IDOrganizator__)
) ;

CREATE TABLE Author_of_paper_student (
	__IDAuthor_of_paper_student__ Integer NOT NULL,
	PRIMARY KEY Author_of_paper_student (__IDAuthor_of_paper_student__)
) ;

CREATE TABLE Best_Student_Paper_Award (
	__IDBest_Student_Paper_Award__ Integer NOT NULL,
	PRIMARY KEY Best_Student_Paper_Award (__IDBest_Student_Paper_Award__)
) ;

CREATE TABLE ACM_SIGKDD (
	__IDACM_SIGKDD__ Integer NOT NULL,
	FOREIGN KEY hold (__FKhold__) REFERENCES Conference (__IDConference__),
	FOREIGN KEY search (__FKsearch__) REFERENCES Sponzor (__IDSponzor__),
	FOREIGN KEY design (__FKdesign__) REFERENCES Deadline (__IDDeadline__),
	PRIMARY KEY ACM_SIGKDD (__IDACM_SIGKDD__),
	__FKhold__ Integer,
	__FKsearch__ Integer,
	__FKdesign__ Integer
) ;

CREATE TABLE Sponzor (
	__IDSponzor__ Integer NOT NULL,
	FOREIGN KEY searched_by (__FKsearched_by__) REFERENCES ACM_SIGKDD (__IDACM_SIGKDD__),
	Name_of_sponsor text,
	PRIMARY KEY Sponzor (__IDSponzor__),
	__FKsearched_by__ Integer
) ;

CREATE TABLE Exhibitor (
	__IDExhibitor__ Integer NOT NULL,
	PRIMARY KEY Exhibitor (__IDExhibitor__)
) ;

CREATE TABLE Registration_SIGMOD_Member (
	__IDRegistration_SIGMOD_Member__ Integer NOT NULL,
	PRIMARY KEY Registration_SIGMOD_Member (__IDRegistration_SIGMOD_Member__)
) ;
...
CREATE TABLE Registration_fee (
	...
	FOREIGN KEY designed_by (__FKdesigned_by__) REFERENCES ACM_SIGKDD (__IDACM_SIGKDD__),
	Date text,
	FOREIGN KEY payed_by (__FKpayed_by__) REFERENCES Person (__IDPerson__),
	Price Integer,
	Currency text,
	PRIMARY KEY Registration_fee (__IDRegistration_fee__),
	__FKdesigned_by__ Integer,
	__FKpayed_by__ Integer
) ;

CREATE TABLE Bronze_Supporter (
	__IDBronze_Supporter__ Integer NOT NULL,
	PRIMARY KEY Bronze_Supporter (__IDBronze_Supporter__)
) ;

CREATE TABLE Platinum_Supporter (
	__IDPlatinum_Supporter__ Integer NOT NULL,
	PRIMARY KEY Platinum_Supporter (__IDPlatinum_Supporter__)
) ;
...
CREATE TABLE Best_Paper_Awards_Committee (
	__IDBest_Paper_Awards_Committee__ Integer NOT NULL,
	PRIMARY KEY Best_Paper_Awards_Committee (__IDBest_Paper_Awards_Committee__)
) ;
...
CREATE TABLE "Registration_Non-Member" (
	"__IDRegistration_Non-Member__" Integer NOT NULL,
	PRIMARY KEY "Registration_Non-Member" ("__IDRegistration_Non-Member__")
) ;

CREATE TABLE Sponzor_fee (
	__IDSponzor_fee__ Integer NOT NULL,
	PRIMARY KEY Sponzor_fee (__IDSponzor_fee__)
) ;

CREATE TABLE Registration_SIGKDD_Member (
	__IDRegistration_SIGKDD_Member__ Integer NOT NULL,
	PRIMARY KEY Registration_SIGKDD_Member (__IDRegistration_SIGKDD_Member__)
) ;
...
CREATE TABLE General_Chair (
	__IDGeneral_Chair__ Integer NOT NULL,
	PRIMARY KEY General_Chair (__IDGeneral_Chair__)
) ;

CREATE TABLE Gold_Supporter (
	__IDGold_Supporter__ Integer NOT NULL,
	PRIMARY KEY Gold_Supporter (__IDGold_Supporter__)
) ;

CREATE TABLE Registration_Student (
	__IDRegistration_Student__ Integer NOT NULL,
	PRIMARY KEY Registration_Student (__IDRegistration_Student__)
) ;
...
CREATE TABLE Best_Research_Paper_Award (
	__IDBest_Research_Paper_Award__ Integer NOT NULL,
	PRIMARY KEY Best_Research_Paper_Award (__IDBest_Research_Paper_Award__)
) ;

CREATE TABLE Best_Student_Paper_Supporter (
	__IDBest_Student_Paper_Supporter__ Integer NOT NULL,
	PRIMARY KEY Best_Student_Paper_Supporter (__IDBest_Student_Paper_Supporter__)
) ;

CREATE TABLE Silver_Supporter (
	__IDSilver_Supporter__ Integer NOT NULL,
	PRIMARY KEY Silver_Supporter (__IDSilver_Supporter__)
) ;

CREATE TABLE Organizing_Committee_member (
	__IDOrganizing_Committee_member__ Integer NOT NULL,
	PRIMARY KEY Organizing_Committee_member (__IDOrganizing_Committee_member__)
) ;

CREATE TABLE Author_of_paper (
	__IDAuthor_of_paper__ Integer NOT NULL,
	PRIMARY KEY Author_of_paper (__IDAuthor_of_paper__)
) ;
...
CREATE TABLE Author_conflictsWith_Thing (
	__IDAuthor__ Integer NOT NULL,
	__IDThing__ Integer NOT NULL
) ;
...
CREATE TABLE Proceedings_includes_Thing (
	__IDProceedings__ Integer NOT NULL,
	__IDThing__ Integer NOT NULL
) ;

CREATE TABLE Award_awarded_by_Organizator (
	__IDAward__ Integer NOT NULL,
	__IDOrganizator__ Integer NOT NULL
) ;
