...
CREATE TABLE UnderlineProperty (
	__IDUnderlineProperty__ Integer NOT NULL,
	val text,
	color text,
	PRIMARY KEY UnderlineProperty (__IDUnderlineProperty__)
) ;
...
CREATE TABLE ParaPrElt (
	...
	FOREIGN KEY ppe_styleElt (__FKppe_styleElt__) REFERENCES StyleElt (__IDStyleElt__),
	FOREIGN KEY pStyle (__FKpStyle__) REFERENCES StringProperty (__IDStringProperty__),
	keepNext text,
	keepLines text,
	pageBreakBefore text,
	supressLineNumbers text,
	suppressAutoHyphens text,
	contextualSpacing text,
	bidi text,
	justification text,
	PRIMARY KEY ParaPrElt (__IDParaPrElt__),
	__FKpStyle__ Integer,
	__FKppe_pElt__ Integer,
	__FKppe_styleElt__ Integer
) ;
...
CREATE TABLE RunPrElt (
	...
	FOREIGN KEY rpe_styleElt (__FKrpe_styleElt__) REFERENCES StyleElt (__IDStyleElt__),
	FOREIGN KEY rStyle (__FKrStyle__) REFERENCES StringProperty (__IDStringProperty__),
	FOREIGN KEY rFonts (__FKrFonts__) REFERENCES FontsElt (__IDFontsElt__),
	bold text,
	bold_cs text,
	italic text,
	italic_cs text,
	...
	rtl text,
	cs text,
	FOREIGN KEY underline (__FKunderline__) REFERENCES UnderlineProperty (__IDUnderlineProperty__),
	color text,
	highlight text,
	verticalAlign text,
	FOREIGN KEY language (__FKlanguage__) REFERENCES LangElt (__IDLangElt__),
	PRIMARY KEY RunPrElt (__IDRunPrElt__),
	__FKunderline__ Integer,
	__FKlanguage__ Integer,
	__FKrpe_rElt__ Integer,
	__FKrFonts__ Integer,
	__FKrpe_styleElt__ Integer,
	__FKrStyle__ Integer
) ;

CREATE TABLE LangElt (
	__IDLangElt__ Integer NOT NULL,
	FOREIGN KEY le_runPrElt (__FKle_runPrElt__) REFERENCES RunPrElt (__IDRunPrElt__),
	val text,
	bidi text,
	PRIMARY KEY LangElt (__IDLangElt__),
	__FKle_runPrElt__ Integer
) ;
...
CREATE TABLE TablePrElt (
	...
	FOREIGN KEY tpe_styleElt (__FKtpe_styleElt__) REFERENCES StyleElt (__IDStyleElt__),
	PRIMARY KEY TablePrElt (__IDTablePrElt__),
	__FKtpe_styleElt__ Integer,
...
CREATE TABLE TableRowPrElt (
	...
	FOREIGN KEY trpe_styleElt (__FKtrpe_styleElt__) REFERENCES StyleElt (__IDStyleElt__),
	PRIMARY KEY TableRowPrElt (__IDTableRowPrElt__),
	__FKtrpe_styleElt__ Integer,
...
CREATE TABLE TableCellPrElt (
	...
	FOREIGN KEY tcpe_styleElt (__FKtcpe_styleElt__) REFERENCES StyleElt (__IDStyleElt__),
	PRIMARY KEY TableCellPrElt (__IDTableCellPrElt__),
	__FKtcpe_tableCellElt__ Integer,
	__FKtcpe_styleElt__ Integer
) ;
...
CREATE TABLE FontsListElt (
	...
	FOREIGN KEY defaultFonts (__FKdefaultFonts__) REFERENCES FontsElt (__IDFontsElt__),
	PRIMARY KEY FontsListElt (__IDFontsListElt__),
	__FKdefaultFonts__ Integer,
	__FKfle_wordDocument__ Integer
) ;

CREATE TABLE FontsElt (
	__IDFontsElt__ Integer NOT NULL,
	FOREIGN KEY fse_fontsListElt (__FKfse_fontsListElt__) REFERENCES FontsListElt (__IDFontsListElt__),
	FOREIGN KEY fse_runPrElt (__FKfse_runPrElt__) REFERENCES RunPrElt (__IDRunPrElt__),
	hint text,
	FOREIGN KEY ascii (__FKascii__) REFERENCES StringType (__IDStringType__),
	FOREIGN KEY h_ansi (__FKh_ansi__) REFERENCES StringType (__IDStringType__),
	FOREIGN KEY fareast (__FKfareast__) REFERENCES StringType (__IDStringType__),
	FOREIGN KEY cs (__FKcs__) REFERENCES StringType (__IDStringType__),
	PRIMARY KEY FontsElt (__IDFontsElt__),
	__FKascii__ Integer,
	__FKh_ansi__ Integer,
	__FKfareast__ Integer,
	__FKfse_runPrElt__ Integer,
	__FKfse_fontsListElt__ Integer,
	__FKcs__ Integer
) ;

CREATE TABLE FontElt (
	__IDFontElt__ Integer NOT NULL,
	FOREIGN KEY fe_fontsListElt (__FKfe_fontsListElt__) REFERENCES FontsListElt (__IDFontsListElt__),
	FOREIGN KEY name (__FKname__) REFERENCES StringType (__IDStringType__),
	FOREIGN KEY altName (__FKaltName__) REFERENCES StringProperty (__IDStringProperty__),
	PRIMARY KEY FontElt (__IDFontElt__),
	__FKfe_fontsListElt__ Integer,
	__FKname__ Integer,
	__FKaltName__ Integer
) ;
...
CREATE TABLE StylesElt (
	...
	versionOfBuiltInStylenames "Double",
	PRIMARY KEY StylesElt (__IDStylesElt__),
	__FKse_wordDocument__ Integer
) ;

CREATE TABLE StyleElt (
	__IDStyleElt__ Integer NOT NULL,
	FOREIGN KEY se_stylesElt (__FKse_stylesElt__) REFERENCES StylesElt (__IDStylesElt__),
	type text,
	FOREIGN KEY styleId (__FKstyleId__) REFERENCES StringType (__IDStringType__),
	"default" text,
	FOREIGN KEY name (__FKname__) REFERENCES StringProperty (__IDStringProperty__),
	FOREIGN KEY aliases (__FKaliases__) REFERENCES StringProperty (__IDStringProperty__),
	sti "Double",
	FOREIGN KEY basedOn (__FKbasedOn__) REFERENCES StringProperty (__IDStringProperty__),
	FOREIGN KEY next (__FKnext__) REFERENCES StringProperty (__IDStringProperty__),
	FOREIGN KEY link (__FKlink__) REFERENCES StringProperty (__IDStringProperty__),
	autoRedefine text,
	hidden text,
	semiHidden text,
	locked text,
	personal text,
	personalCompose text,
	personalReply text,
	FOREIGN KEY rsid (__FKrsid__) REFERENCES StringType (__IDStringType__),
	FOREIGN KEY se_pPr (__FKse_pPr__) REFERENCES ParaPrElt (__IDParaPrElt__),
	FOREIGN KEY se_rPr (__FKse_rPr__) REFERENCES RunPrElt (__IDRunPrElt__),
	FOREIGN KEY se_tblPr (__FKse_tblPr__) REFERENCES TablePrElt (__IDTablePrElt__),
	FOREIGN KEY se_trPr (__FKse_trPr__) REFERENCES TableRowPrElt (__IDTableRowPrElt__),
	FOREIGN KEY se_tcPr (__FKse_tcPr__) REFERENCES TableCellPrElt (__IDTableCellPrElt__),
	PRIMARY KEY StyleElt (__IDStyleElt__),
	__FKse_trPr__ Integer,
	__FKnext__ Integer,
	__FKrsid__ Integer,
	__FKname__ Integer,
	__FKse_rPr__ Integer,
	__FKstyleId__ Integer,
	__FKse_tblPr__ Integer,
	__FKlink__ Integer,
	__FKaliases__ Integer,
	__FKse_pPr__ Integer,
	__FKse_tcPr__ Integer,
	__FKse_stylesElt__ Integer,
	__FKbasedOn__ Integer
) ;
...
CREATE TABLE FontsListElt_fonts_FontElt (
	__IDFontsListElt__ Integer NOT NULL,
	__IDFontElt__ Integer NOT NULL
) ;
...
CREATE TABLE StylesElt_styles_StyleElt (
	__IDStylesElt__ Integer NOT NULL,
	__IDStyleElt__ Integer NOT NULL
) ;
