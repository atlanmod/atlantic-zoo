module Crsdr {
	...
	type Conference : Thing, Event, Working_event {
	...
	type Paper : Regular_contribution, Document, Contribution {
	...
	type Author : ConferenceMember, User, Person {
	...
	type Workshop : Working_event, Conference_part, Event;
	...
	type Tutorial : Working_event, Conference_part;
