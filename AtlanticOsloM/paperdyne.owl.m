module Paperdyne {
	...
	type Conference : Scientific_Event, Working_event, Thing, Event {
	...
	type Paper : Contribution, Domain_Topic, ActivitySubmissionForm, Article, Regular_contribution, Document {
	...
	type Administrator : User, Person, ProgramCommitteeMember {
		Approve_Ref : Event?;
		Assign_Ref : Role?;
		Assigns_Ref : Thing?;
	...
	type Workshop : Conference_part, Event, Activity, Scientific_Event, AcademicEvent, Working_event;

	type Tutorial : Conference_part, Activity, Lecture, Individual_Presentation, Working_event;
	...
	type Accepted_Paper : Paper, Evaluated_Paper;

	type Rejected_Paper : Paper, Evaluated_Paper;
	...
	type University : Organization, Academic_Institution;
	...
	type Review : Article, Conference_document, Thing, Document {
	...
	type Session : Scientific_Event, Lecture, Event, Thing {
	...
	type Proceedings : @[Multi-author_Volume], OutputDocument {
		Includes_Ref : Thing*;
	};
	...
	type Chair : ProgramCommitteeMember, Person, Committee_member {
	...
	type Member : People, Participant {
	...
	type Author : People, Speaker, Person, ConferenceMember, User {
	...
	type EEnum {"male", "female", "high", "medium", "low", "very high", "submitted", "missing", "notStarted", "active", "finished", "accepted", "rejected", "regular", "invited", "lowBid", "-", "CONFLICT", "wantNot", "highBid", "Yes", "No", "Unsure", "Compilers", "Microarchitecture", "Systems", "ForwardLookingIdea", "Accept", "Reject", "Unsure"};
}