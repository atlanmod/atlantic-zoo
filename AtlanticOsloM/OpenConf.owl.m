module Openconf {
	...
	type Abstract : Paper, Extended_abstract, Document {
	...
	type Reviewer : Member, ProgramCommitteeMember, Organizer, Speaker, Person, ConferenceMember, User {
	...
	type EEnum {"Yes", "No", "Unsure", "Accept", "Reject", "Unsure", "male", "female", "high", "medium", "low", "very high", "Compilers", "Microarchitecture", "Systems", "ForwardLookingIdea"};
}