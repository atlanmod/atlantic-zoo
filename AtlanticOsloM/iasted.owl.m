module Iasted {
	...
	type Reviewer : ConferenceMember, User, Speaker, Person {
	...
	type Conference : Thing, Scientific_Event, Event, Working_event {
	...
	type Tutorial : Conference_part, Session, Individual_Presentation, Working_event;
	...
	type Workshop : AcademicEvent, Working_event, Conference_part, Event, Scientific_Event;
	...
	type Paper : Contribution, Article, Regular_contribution, Document {
	...
	type Lecture : Conference_activity;
