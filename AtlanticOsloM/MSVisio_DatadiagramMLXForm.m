module DatadiagramMLXForm {
	...
	type DocumentSettingsElt {
		...
		TopPage_ContRef : Page?;
		DefaultTextStyle_ContRef : StyleSheet?;
		DefaultLineStyle_ContRef : StyleSheet?;
		DefaultFillStyle_ContRef : StyleSheet?;
		DefaultGuideStyle_ContRef : StyleSheet?;
		GlueSettings_Att : Integer32;
		SnapSettings_Att : Integer32;
		SnapExtensions_Att : Integer32;
		Ds_snapAngles_ContRef : SnapAnglesCollection?;
		DynamicGridEnabled_Att : Logical;
		ProtectStyles_Att : Logical;
		ProtectShapes_Att : Logical;
		ProtectMasters_Att : Logical;
		ProtectBkgnds_Att : Logical;
		CustomMenusFile_Att : Text;
		CustomToolbarsFile_Att : Text;
		AttachedToolbars_Att : Text;
	};

	type SnapAnglesCollection {
		Sa_docSettings_Ref : DocumentSettingsElt;
		SnapAngles_ContRef : SnapAngle*;
	};

	type SnapAngle {
		Sa_snapAngles_Ref : SnapAnglesCollection;
		AngleValue_Att : Double;
	};
	...
	type XForm : ShapeElt, DelElt {
		PinX_ContRef : CellType?;
		PinY_ContRef : CellType?;
		Width_ContRef : CellType?;
		Height_ContRef : CellType?;
		LocPinX_ContRef : CellType?;
		LocPinY_ContRef : CellType?;
		Angle_ContRef : CellType?;
		FlipX_ContRef : CellType?;
		FlipY_ContRef : CellType?;
		ResizeMode_ContRef : CellType?;
	};
