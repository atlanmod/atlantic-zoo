module Edas {
	...
	type Paper : Document, Article, Regular_contribution, Contribution {
	...
	type Conference : Event, Thing, Working_event {
	...
	type Workshop : Working_event, Conference_part, Event, AcademicEvent;
	...
	type Author : Person, User, ConferenceMember {
