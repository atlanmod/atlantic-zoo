module ConfOf {
	...
	type Conference : Thing, Working_event, Event {
	...
	type Paper : Document, Contribution, Regular_contribution {
	...
	type Workshop : Conference_part, Event, Working_event;

	type Tutorial : Conference_part, Working_event;
