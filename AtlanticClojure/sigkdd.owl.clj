...
( defstruct Hotel )
( defstruct Deadline_Abstract_Submission )
( defstruct Best_Applications_Paper_Award )
( defstruct Award )
( defstruct Deadline_Paper_Submission )
( defstruct Deadline_Author_notification )
( defstruct Webmaster )
( defstruct Organizator )
( defstruct Author_of_paper_student )
( defstruct Best_Student_Paper_Award )
( defstruct ACM_SIGKDD )
( defstruct Sponzor )
( defstruct Exhibitor )
( defstruct Registration_SIGMOD_Member )
( defstruct Registration_fee )
( defstruct Bronze_Supporter )
( defstruct Platinum_Supporter )
( defstruct Conference_hall )
( defstruct Best_Paper_Awards_Committee )
( defstruct Program_Chair )
( defstruct Main_office )
( defstruct Registration_Non-Member )
( defstruct Sponzor_fee )
( defstruct Registration_SIGKDD_Member )
( defstruct Program_Committee )
( defstruct General_Chair )
( defstruct Gold_Supporter )
( defstruct Registration_Student )
( defstruct Organizing_Committee )
( defstruct Listener )
( defstruct Program_Committee_member )
( defstruct Invited_Speaker )
( defstruct Best_Research_Paper_Award )
( defstruct Best_Student_Paper_Supporter )
( defstruct Silver_Supporter )
( defstruct Organizing_Committee_member )
( defstruct Author_of_paper )
