...
( defstruct StylesCollection :s_workbook )
( defstruct StyleType :st_styles :st_styledElement :id :st_parent )
( defstruct ProtectionType :pt_styleType )
( defstruct AlignmentType :at_styleType )
( defstruct BordersType :bt_styleType )
( defstruct BorderType :bt_bordersType :position )
( defstruct FontType :ft_styleType )
( defstruct InteriorType :it_styleType )
( defstruct NumberFormatType :nft_styleType )
( defstruct NamesType :nt_workbook )
( defstruct NamedRange :nr_namesType :name )
